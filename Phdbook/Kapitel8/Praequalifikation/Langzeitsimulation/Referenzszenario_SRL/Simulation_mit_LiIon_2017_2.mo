...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(zyklanzahl_von_SOC.Zyklen, Zyklenzahl) annotation (Line(points={{27.8,-202},{12,-202},{12,-284},{50,-284}}, color={0,0,127}));
  connect(Energie_Spotmarkt.y, Spotmarktangebot) annotation (Line(points={{-73,-146},{-96,-146},{-96,-148},{-100,-148}}, color={0,0,127}));
  connect(Energie_gesetzt.y, Einspeisung) annotation (Line(points={{-187,-32},{-194,-32},{-194,-28},{-210,-28}}, color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-185.2,29},{-193.6,29},{-193.6,30},{-212,30}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  annotation (
