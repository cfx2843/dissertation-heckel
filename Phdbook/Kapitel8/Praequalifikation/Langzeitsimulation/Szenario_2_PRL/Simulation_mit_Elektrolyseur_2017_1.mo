...
model Simulation_mit_Elektrolyseur_2017_1
  import MABook;
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(G.y, regler_Virtuelles_Kraftwerk.PRL_Angebot) annotation (Line(points={{318,-119},{200,-119},{200,-131.467},{79.56,-131.467}}, color={0,0,127}));
  connect(Zuverlaessigkeit.Erfuellt, regler_Virtuelles_Kraftwerk.PRL_erfuellt) annotation (Line(points={{-99.2,18.8},{-52.6,18.8},{-52.6,17.1556},{-5.46,17.1556}},
                                                                                                                                                                color={255,0,255}));
  connect(Summe_Leistung_gesetzt.y, Energie_gesetzt.u) annotation (Line(points={{-119.02,-52},{-136,-52},{-136,-46},{-152,-46}}, color={0,0,127}));
  ...
  connect(elektrolyseur_statisch.epp, ElectricGrid.epp) annotation (Line(
      points={{81.34,-185.2},{192.66,-185.2},{192.66,206},{178,206}},
      color={0,135,135},
      thickness=0.5));
  connect(Energie_Ely.u, regler_Virtuelles_Kraftwerk.P_sum_AP) annotation (Line(points={{-120,-136},{-54,-136},{-54,-143.2},{-3.12,-143.2}}, color={0,0,127}));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{322,-209},{322,-176},{322,-142},{318,-142}},
                                                                                              color={0,0,127}));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-175,-46},{-220,-46},{-220,-42},{-230,-42}},
                                                                                           color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-121.2,13},{-155.6,13},{-155.6,16},{-214,16}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Spotmarktangebot,Spotmarktangebot)  annotation (Line(points={{-242,-130},{-242,-130}},                         color={0,0,127}));
  connect(M_H2.y,Wasserstoffmasse)  annotation (Line(points={{-111,-232},{-212,-232},{-212,-228},{-228,-228}},
                                                                                     color={0,0,127}));
  connect(Energie_Ely.y,Spotmarktangebot)  annotation (Line(points={{-143,-136},{-192,-136},{-192,-130},{-242,-130}}, color={0,0,127}));
  connect(elektrolyseur_statisch.m_dot_H2, M_H2.u) annotation (Line(points={{83.32,-210},{106,-210},{106,-278},{-56,-278},{-56,-232},{-88,-232}}, color={0,0,127}));
  connect(elektrolyseur_statisch.electricPowerOut, regler_Virtuelles_Kraftwerk.Max_P_Erzeuger) annotation (Line(
      points={{85.96,-229.2},{124,-229.2},{124,-106.044},{79.56,-106.044}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(elektrolyseur_statisch.P_el_set, regler_Virtuelles_Kraftwerk.P_set_Elektrolyseur) annotation (Line(points={{18.31,-192.4},{-28,-192.4},{-28,-114.844},{-3.12,-114.844}}, color={0,127,127}));
  annotation (
...
end Simulation_mit_Elektrolyseur_2017_1;
