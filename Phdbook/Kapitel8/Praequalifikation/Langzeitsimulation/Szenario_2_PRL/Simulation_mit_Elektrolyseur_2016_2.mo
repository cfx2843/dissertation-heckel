...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(elektrolyseur_statisch.epp, ElectricGrid.epp) annotation (Line(
      points={{81.34,-185.2},{153.34,-185.2},{153.34,206},{178,206}},
      color={0,135,135},
      thickness=0.5));
  connect(Energie_Ely.u, regler_Virtuelles_Kraftwerk.P_sum_AP) annotation (Line(points={{-118,-142},{-50,-142},{-50,-143.2},{-3.12,-143.2}}, color={0,0,127}));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{322,-193},{322,-142},{318,-142}},
                                                                                              color={0,0,127}));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-177,-52},{-208,-52},{-208,-50},{-240,-50}},
                                                                                           color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-121.2,13},{-165.6,13},{-165.6,8},{-224,8}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Spotmarktangebot,Spotmarktangebot)  annotation (Line(points={{-252,-138},{-252,-138}},                         color={0,0,127}));
  connect(M_H2.y,Wasserstoffmasse)  annotation (Line(points={{-147,-226},{-222,-226},{-222,-236},{-238,-236}},
                                                                                     color={0,0,127}));
  connect(Energie_Ely.y,Spotmarktangebot)  annotation (Line(points={{-141,-142},{-202,-142},{-202,-138},{-252,-138}}, color={0,0,127}));
  connect(elektrolyseur_statisch.m_dot_H2, M_H2.u) annotation (Line(points={{83.32,-210},{122,-210},{122,-270},{-88,-270},{-88,-226},{-124,-226}}, color={0,0,127}));
  connect(elektrolyseur_statisch.electricPowerOut, regler_Virtuelles_Kraftwerk.Max_P_Erzeuger) annotation (Line(
      points={{85.96,-229.2},{108,-229.2},{108,-106.044},{79.56,-106.044}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_Elektrolyseur, elektrolyseur_statisch.P_el_set) annotation (Line(
      points={{-3.12,-114.844},{-26,-114.844},{-26,-192.4},{18.31,-192.4}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  annotation (
