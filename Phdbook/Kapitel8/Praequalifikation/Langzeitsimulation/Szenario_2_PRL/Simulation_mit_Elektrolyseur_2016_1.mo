within Phdbook.Kapitel8.Praequalifikation.Langzeitsimulation.Szenario_2_PRL;
model Simulation_mit_Elektrolyseur_2016_1
  import MABook;
 ...
 Modelica.Blocks.Interfaces.RealOutput Sicherheit annotation (Placement(transformation(
        ...
        origin={-222,6})));
protected
  parameter Modelica.Units.SI.Power P_Ely=1.9244e6;
  ...
  Modelica.Blocks.Continuous.Integrator Energie_gesetzt annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-148,-52})));
  Modelica.Blocks.Continuous.Integrator Energie_Ely annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={-148,-138})));
  ...
  TransiEnt.Basics.Tables.GenericDataTable Prognose_Optimierung_S1(
    ...
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Wetterdaten/Prognose_2016_S1.txt",
    shiftTime=0) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=90,
        origin={318,-188})));
  Phdbook.Kapitel8.Praequalifikation.Anlagen.Brennstoffzellen.Elektrolyseur_statisch elektrolyseur_statisch(eta_ely=0.75, P_max(displayUnit="MW") = P_Ely) annotation (Placement(transformation(
        extent={{-33,-40},{33,40}},
        rotation=0,
        origin={49,-210})));
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(Frequenzdaten.y1,primaryBalancingController. Frequenzy) annotation (Line(points={{182,231},{210,231},{210,-96.7},{163.2,-96.7}},
                                                                                                                                     color={0,0,127}));
  ...
  connect(G.y,primaryBalancingController. PRL_Angebot) annotation (Line(points={{318,-119},{318,-110.3},{163.3,-110.3}},
                                                                                                                      color={0,0,127}));
  ...
  connect(Wind_1.epp,ElectricGrid. epp) annotation (Line(
      ...
      color={0,135,135},
      thickness=0.5));
  connect(regler_Virtuelles_Kraftwerk.PRL_set, primaryBalancingController.P_set) annotation (Line(points={{79.56,-120.711},{91.39,-120.711},{91.39,-102.2},{140.2,-102.2}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_Wind_1, Wind_1.MaxP_Out) annotation (Line(points={{79.56,-33.6889},{104,-33.6889},{104,184.6},{68.6,184.6}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_Wind_2, Wind_3.MaxP_Out) annotation (Line(points={{79.56,-26.8444},{100,-26.8444},{100,154.6},{68.6,154.6}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_Wind_3, Wind_5.MaxP_Out) annotation (Line(points={{79.56,-20},{96,-20},{96,120.6},{68.6,120.6}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_Wind_4, Wind_7.MaxP_Out) annotation (Line(points={{79.56,-13.1556},{92,-13.1556},{92,84.6},{66.6,84.6}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_Wind_5, Wind_9.MaxP_Out) annotation (Line(points={{79.56,-6.31111},{88,-6.31111},{88,50.6},{66.6,50.6}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.P_set_Wind_1, Wind_1.P_set) annotation (Line(
      points={{-3.9,-40.5333},{-40,-40.5333},{-40,170.3},{47.2,170.3}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_Wind_2, Wind_3.P_set) annotation (Line(
      points={{-3.9,-32.7111},{-30,-32.7111},{-30,140.3},{47.2,140.3}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_Wind_3, Wind_5.P_set) annotation (Line(
      points={{-3.9,-25.8667},{-18,-25.8667},{-18,106.3},{47.2,106.3}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_Wind_4, Wind_7.P_set) annotation (Line(
      points={{-3.9,-19.0222},{-8,-19.0222},{-8,70.3},{45.2,70.3}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_Wind_5, Wind_9.P_set) annotation (Line(
      points={{-3.9,-12.1778},{-3.9,36.3},{45.2,36.3}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_PV_5, PV_4.P_set) annotation (Line(
      points={{-3.9,-62.0444},{-48,-62.0444},{-48,194},{57.4,194},{57.4,197.5}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_PV_4, PV_18.P_set) annotation (Line(
      points={{-3.9,-68.8889},{-56,-68.8889},{-56,227.5},{57.4,227.5}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_PV_3, PV_15.P_set) annotation (Line(
      points={{-3.9,-74.7556},{-66,-74.7556},{-66,259.5},{57.4,259.5}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_PV_2, PV_13.P_set) annotation (Line(
      points={{-3.9,-81.6},{-76,-81.6},{-76,293.5},{57.4,293.5}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.P_set_PV_1, PV_11.P_set) annotation (Line(
      points={{-3.9,-88.4444},{-86,-88.4444},{-86,325.5},{57.4,325.5}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk.Max_PV_5, PV_4.MaxP_out) annotation (Line(points={{78.78,-55.2},{110,-55.2},{110,216.4},{71.2,216.4}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_PV_4, PV_18.MaxP_out) annotation (Line(points={{78.78,-62.0444},{116,-62.0444},{116,246.4},{71.2,246.4}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_PV_3, PV_15.MaxP_out) annotation (Line(points={{78.78,-68.8889},{122,-68.8889},{122,278.4},{71.2,278.4}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_PV_2, PV_13.MaxP_out) annotation (Line(points={{78.78,-75.7333},{128,-75.7333},{128,312.4},{71.2,312.4}}, color={0,127,127}));
  connect(regler_Virtuelles_Kraftwerk.Max_PV_1, PV_11.MaxP_out) annotation (Line(points={{78.78,-82.5778},{134,-82.5778},{134,344.4},{71.2,344.4}}, color={0,127,127}));
  connect(G.y, regler_Virtuelles_Kraftwerk.PRL_Angebot) annotation (Line(points={{318,-119},{174,-119},{174,-131.467},{79.56,-131.467}}, color={0,0,127}));
  connect(Zuverlaessigkeit.Erfuellt, regler_Virtuelles_Kraftwerk.PRL_erfuellt) annotation (Line(points={{-137.2,12.8},{-52.6,12.8},{-52.6,17.1556},{-5.46,17.1556}},
                                                                                                                                                                color={255,0,255}));
  connect(Summe_Leistung_gesetzt.y, Energie_gesetzt.u) annotation (Line(points={{-119.02,-52},{-136,-52}},                       color={0,0,127}));
  ...
  connect(elektrolyseur_statisch.epp, ElectricGrid.epp) annotation (Line(
      points={{81.34,-185.2},{185.34,-185.2},{185.34,206},{178,206}},
      color={0,135,135},
      thickness=0.5));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{318,-177},{318,-142}}, color={0,0,127}));
  connect(Energie_Ely.u, regler_Virtuelles_Kraftwerk.P_sum_AP) annotation (Line(points={{-136,-138},{-70,-138},{-70,-143.2},{-3.12,-143.2}}, color={0,0,127}));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-159,-52},{-238,-52}}, color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-159.2,7},{-163.6,7},{-163.6,6},{-222,6}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Spotmarktangebot,Spotmarktangebot)  annotation (Line(points={{-250,-140},{-250,-140}},                         color={0,0,127}));
  connect(M_H2.y,Wasserstoffmasse)  annotation (Line(points={{-173,-242},{-220,-242},{-220,-238},{-236,-238}},
                                                                                     color={0,0,127}));
  connect(Energie_Ely.y, Spotmarktangebot) annotation (Line(points={{-159,-138},{-200,-138},{-200,-140},{-250,-140}}, color={0,0,127}));
  connect(elektrolyseur_statisch.m_dot_H2, M_H2.u) annotation (Line(points={{83.32,-210},{96,-210},{96,-268},{-144,-268},{-144,-242},{-150,-242}}, color={0,0,127}));
  connect(regler_Virtuelles_Kraftwerk.P_set_Elektrolyseur, elektrolyseur_statisch.P_el_set) annotation (Line(
      points={{-3.12,-114.844},{-30,-114.844},{-30,-192.4},{18.31,-192.4}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(elektrolyseur_statisch.electricPowerOut, regler_Virtuelles_Kraftwerk.Max_P_Erzeuger) annotation (Line(
      points={{85.96,-229.2},{120,-229.2},{120,-106.044},{79.56,-106.044}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  annotation (
...
end Simulation_mit_Elektrolyseur_2016_1;
