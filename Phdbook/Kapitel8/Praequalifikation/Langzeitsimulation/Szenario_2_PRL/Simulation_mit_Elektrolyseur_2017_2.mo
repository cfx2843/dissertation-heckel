...
model Simulation_mit_Elektrolyseur_2017_2
  import MABook;
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(Zuverlaessigkeit.Erfuellt, regler_Virtuelles_Kraftwerk.PRL_erfuellt) annotation (Line(points={{-145.2,16.8},{-52.6,16.8},{-52.6,17.1556},{-5.46,17.1556}},
                                                                                                                                                                color={255,0,255}));
  ...
  connect(elektrolyseur_statisch.epp, ElectricGrid.epp) annotation (Line(
      points={{81.34,-185.2},{155.34,-185.2},{155.34,206},{178,206}},
      color={0,135,135},
      thickness=0.5));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{318,-169},{318,-142}}, color={0,0,127}));
  connect(Energie_Ely.u, regler_Virtuelles_Kraftwerk.P_sum_AP) annotation (Line(points={{-140,-138},{-52,-138},{-52,-143.2},{-3.12,-143.2}}, color={0,0,127}));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-177,-52},{-220,-52},{-220,-48},{-268,-48}},
                                                                                           color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-167.2,11},{-193.6,11},{-193.6,10},{-252,10}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Spotmarktangebot,Spotmarktangebot)  annotation (Line(points={{-280,-136},{-280,-136}},                         color={0,0,127}));
  connect(M_H2.y,Wasserstoffmasse)  annotation (Line(points={{-177,-226},{-250,-226},{-250,-234},{-266,-234}},
                                                                                     color={0,0,127}));
  connect(Energie_Ely.y,Spotmarktangebot)  annotation (Line(points={{-163,-138},{-230,-138},{-230,-136},{-280,-136}}, color={0,0,127}));
  connect(elektrolyseur_statisch.m_dot_H2, M_H2.u) annotation (Line(points={{83.32,-210},{110,-210},{110,-282},{-108,-282},{-108,-226},{-154,-226}}, color={0,0,127}));
  connect(regler_Virtuelles_Kraftwerk.P_set_Elektrolyseur, elektrolyseur_statisch.P_el_set) annotation (Line(
      points={{-3.12,-114.844},{-40,-114.844},{-40,-192.4},{18.31,-192.4}},
      color={0,135,135},
      pattern=LinePattern.Dash));
...
end Simulation_mit_Elektrolyseur_2017_2;
