...
model Simulation_mit_LiIon_2017_1
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.PRL_erfuellt, Zuverlaessigkeit.Erfuellt) annotation (Line(points={{-4.68,13.1048},{-16.78,13.1048},{-16.78,12.8},{-141.2,12.8}}, color={255,0,255}));
  ...
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_PV_1, Summe_Leistung_gesetzt.u[10]) annotation (Line(
      ...
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.u, Summe_Leistung_gesetzt.y) annotation (Line(points={{-140,-32},{-129.02,-32}}, color={0,0,127}));
  connect(zyklanzahl_von_SOC.SOC, liIon_Battery.SOC) annotation (Line(points={{-145.1,-203.9},{50,-203.9},{50,-202},{54,-202},{54,-183.4}},
                                                                                                                                          color={0,0,127}));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{114,-237},{124,-237},{124,-230},{118,-230},{118,-196}}, color={0,0,127}));
  connect(Energie_gesetzt1.u, regler_Virtuelles_Kraftwerk_mitLiIon.P_sum_AP) annotation (Line(points={{-140,-148},{-70,-148},{-70,-149.486},{-1.56,-149.486}}, color={0,0,127}));
  connect(Energie_gesetzt.y, Einspeisung) annotation (Line(points={{-163,-32},{-162,-32},{-162,-26},{-198,-26}}, color={0,0,127}));
  connect(Energie_gesetzt1.y, Spotmarktangebot) annotation (Line(points={{-163,-148},{-178,-148},{-178,-142},{-194,-142}}, color={0,0,127}));
  connect(zyklanzahl_von_SOC.Zyklen, Zyklenzahl) annotation (Line(points={{-168.2,-204},{-154,-204},{-154,-200},{-180,-200}}, color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage, Sicherheit) annotation (Line(
      points={{-163.2,7},{-162.6,7},{-162.6,10},{-194,10}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  annotation (
...
end Simulation_mit_LiIon_2017_1;
