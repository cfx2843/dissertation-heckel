...
protected
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_11(
    ...
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_11.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_1(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_1.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,178})));
  TransiEnt.Basics.Tables.GenericDataTable Data_3(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_3.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,148})));
  TransiEnt.Basics.Tables.GenericDataTable Data_5(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_5.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,114})));
  TransiEnt.Basics.Tables.GenericDataTable Data_7(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_7.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,78})));
  TransiEnt.Basics.Tables.GenericDataTable Data_9(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_9.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,44})));
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_13(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_13.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_15(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_15.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_18(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_18.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_20(
    ...
    columns={2,3,4,5},
    use_absolute_path=false,
   relativepath="...../Daten/2016/Daten16_20.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Prognose_Optimierung_S1(
    multiple_outputs(
      ...
      fixed=true) = true,
    use_absolute_path=false,
   relativepath="...../Daten/Prognose_2016_S1.txt",
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.PRL_erfuellt, Zuverlaessigkeit.Erfuellt) annotation (Line(points={{-4.68,13.1048},{-16.78,13.1048},{-16.78,12.8},{-121.2,12.8}}, color={255,0,255}));
  ...
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_Wind_5, Summe_Leistung_gesetzt.u[1]) annotation (Line(
      points={{-3.9,2.20952},{-59.56,2.20952},{-59.56,-35.78},{-98,-35.78}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_Wind_4, Summe_Leistung_gesetzt.u[2]) annotation (Line(
      points={{-3.9,-4.49524},{-58.56,-4.49524},{-58.56,-34.94},{-98,-34.94}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_Wind_3, Summe_Leistung_gesetzt.u[3]) annotation (Line(
      points={{-3.9,-14.5524},{-58.56,-14.5524},{-58.56,-34.1},{-98,-34.1}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_Wind_2, Summe_Leistung_gesetzt.u[4]) annotation (Line(
      points={{-3.12,-24.6095},{-59.17,-24.6095},{-59.17,-33.26},{-98,-33.26}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_Wind_1, Summe_Leistung_gesetzt.u[5]) annotation (Line(
      points={{-3.12,-34.6667},{-59.17,-34.6667},{-59.17,-32.42},{-98,-32.42}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_PV_5, Summe_Leistung_gesetzt.u[6]) annotation (Line(
      points={{-2.34,-52.2667},{-58.17,-52.2667},{-58.17,-31.58},{-98,-31.58}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_PV_4, Summe_Leistung_gesetzt.u[7]) annotation (Line(
      points={{-2.34,-60.6476},{-60,-60.6476},{-60,-30.74},{-98,-30.74}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_PV_3, Summe_Leistung_gesetzt.u[8]) annotation (Line(
      points={{-2.34,-71.5429},{-59.17,-71.5429},{-59.17,-29.9},{-98,-29.9}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_PV_2, Summe_Leistung_gesetzt.u[9]) annotation (Line(
      points={{-2.34,-79.0857},{-59.17,-79.0857},{-59.17,-29.06},{-98,-29.06}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_set_PV_1, Summe_Leistung_gesetzt.u[10]) annotation (Line(
      points={{-2.34,-87.4667},{-59.17,-87.4667},{-59.17,-28.22},{-98,-28.22}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.u, Summe_Leistung_gesetzt.y) annotation (Line(points={{-122,-32},{-111.02,-32}}, color={0,0,127}));
  connect(zyklanzahl_von_SOC.SOC, liIon_Battery.SOC) annotation (Line(points={{-117.1,-201.9},{50,-201.9},{50,-202},{54,-202},{54,-183.4}},
                                                                                                                                          color={0,0,127}));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{116,-219},{118,-219},{118,-196}}, color={0,0,127}));
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.P_sum_AP, Energie_gesetzt1.u) annotation (Line(
      points={{-1.56,-149.486},{-62.78,-149.486},{-62.78,-146},{-118,-146}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Zuverlaessigkeit.Percentage, Sicherheit) annotation (Line(
      points={{-143.2,7},{-168.6,7},{-168.6,6},{-200,6}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.y, Einspeisung) annotation (Line(points={{-145,-32},{-168,-32},{-168,-30},{-204,-30}}, color={0,0,127}));
  connect(Energie_gesetzt1.y, Spotmarktangebot) annotation (Line(points={{-141,-146},{-200,-146}}, color={0,0,127}));
  connect(zyklanzahl_von_SOC.Zyklen, Zyklenzahl) annotation (Line(points={{-140.2,-202},{-160,-202},{-160,-204},{-186,-204}}, color={0,0,127}));
  annotation (
