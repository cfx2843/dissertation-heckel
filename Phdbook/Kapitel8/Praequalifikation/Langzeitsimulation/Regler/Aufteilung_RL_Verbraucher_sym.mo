...
block Aufteilung_RL_Verbraucher_sym
  input
...
equation
  ...
  if -2*P_RL_Angebot<=P_max then
    P_set=0.5*P_max+Abruf*P_RL_Angebot;
    P_RL_Restangebot=0;
    P_RL_Rest=0;
  else
...
<p>Aufteilung von Regelleisunng bei Anschluss eines symetrischen Verbrauchers</p>
...
end Aufteilung_RL_Verbraucher_sym;
