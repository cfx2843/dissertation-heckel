...
block Regler_Virtuelles_Kraftwerk_mitSpeicher_rev_FC_NAP
  import MABook;
  import MABook;
  import MABook;
  import MABook;
  ...
  parameter Real SOC_max=0.99 "SOC über dem Speicher nicht genutzt werden soll";
  ...
  Langzeitsimulation.Regler.Aufteilung_RL aufteilung_Wind_2 annotation (Placement(transformation(extent={{-42,-94},{-16,-68}})));
  Langzeitsimulation.Regler.Aufteilung_RL aufteilung_Wind_3 annotation (Placement(transformation(extent={{-8,-108},{18,-82}})));
  Langzeitsimulation.Regler.Aufteilung_RL aufteilung_Wind_4 annotation (Placement(transformation(extent={{26,-122},{52,-96}})));
  Langzeitsimulation.Regler.Aufteilung_RL aufteilung_Wind_5 annotation (Placement(transformation(extent={{60,-136},{86,-110}})));
...
equation
  ...
  connect(aufteilung_Wind_1.P_set, P_set_Wind_1) annotation (Line(
      ...
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Max_Wind_2, aufteilung_Wind_2.P_max) annotation (Line(points={{-106,-104},{-76,-104},{-76,-87.89},{-41.48,-87.89}}, color={0,127,127}));
  connect(aufteilung_Wind_2.P_set, P_set_Wind_2) annotation (Line(
      points={{-14.44,-74.76},{47.78,-74.76},{47.78,-84},{108,-84}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Wind_3.P_set, P_set_Wind_3) annotation (Line(
      points={{19.56,-88.76},{97.78,-88.76},{97.78,-108},{110,-108}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Wind_4.P_set, P_set_Wind_4) annotation (Line(
      points={{53.56,-102.76},{96,-102.76},{96,-132},{110,-132}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Wind_5.P_set, P_set_Wind_5) annotation (Line(
      points={{87.56,-116.76},{110,-116.76},{110,-148}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(greaterEqualThreshold.y, PRL_erfuellt) annotation (Line(points={{95,-174},{98,-174},{98,-174},{112,-174}}, color={255,0,255}));
  connect(aufteilung_Wind_3.P_max, Max_Wind_3) annotation (Line(points={{-7.48,-101.89},{-52.74,-101.89},{-52.74,-120},{-106,-120}},  color={0,127,127}));
  connect(aufteilung_Wind_4.P_max, Max_Wind_4) annotation (Line(points={{26.52,-115.89},{-84,-115.89},{-84,-150},{-106,-150}}, color={0,127,127}));
  connect(aufteilung_Wind_5.P_max, Max_Wind_5) annotation (Line(points={{60.52,-129.89},{-82,-129.89},{-82,-174},{-106,-174}}, color={0,127,127}));
  ...
  connect(aufteilung_PV_1.P_RL_Restangebot, aufteilung_Wind_1.P_RL_Angebot) annotation (Line(
      points={{-58.18,41.1},{-86,41.1},{-86,-56.73},{-79.22,-56.73}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_PV_1.P_RL_Rest, aufteilung_Wind_1.P_RL_set) annotation (Line(
      points={{-58.18,34.6},{-86,34.6},{-86,-62.71},{-79.22,-62.71}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Wind_1.P_RL_Rest, aufteilung_Erzeuger1.P_RL_set) annotation (Line(
      points={{-52.18,-77.4},{-68,-77.4},{-68,-161.25},{15.36,-161.25}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Erzeuger1.P_RL_Angebot, aufteilung_Wind_1.P_RL_Restangebot) annotation (Line(points={{15.68,-153.15},{-64,-153.15},{-64,-70.9},{-52.18,-70.9}}, color={0,127,127}));
  connect(aufteilung_Wind_5.P_RL_Restangebot, greaterEqualThreshold.u) annotation (Line(
      points={{87.82,-126.9},{94,-126.9},{94,-154},{68,-154},{68,-174},{72,-174}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Erzeuger1.P_RL_Restangebot, aufteilung_PV_2.P_RL_Angebot) annotation (Line(
      points={{50.24,-169.5},{-56,-169.5},{-56,29.27},{-45.22,29.27}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_Erzeuger1.P_RL_Rest, aufteilung_PV_2.P_RL_set) annotation (Line(
      points={{50.24,-176.4},{-52,-176.4},{-52,23.29},{-45.22,23.29}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_PV_5.P_RL_Rest, aufteilung_Wind_2.P_RL_set) annotation (Line(
      points={{83.82,-33.4},{-34,-33.4},{-34,-76.71},{-41.22,-76.71}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_PV_5.P_RL_Restangebot, aufteilung_Wind_2.P_RL_Angebot) annotation (Line(
      points={{83.82,-26.9},{90,-26.9},{90,-56},{-41.22,-56},{-41.22,-70.73}},
      color={0,135,135},
      pattern=LinePattern.Dash));
...
end Regler_Virtuelles_Kraftwerk_mitSpeicher_rev_FC_NAP;
