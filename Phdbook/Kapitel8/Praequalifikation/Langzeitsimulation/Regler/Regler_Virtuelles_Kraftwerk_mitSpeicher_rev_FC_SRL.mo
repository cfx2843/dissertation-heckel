...
block Regler_Virtuelles_Kraftwerk_mitSpeicher_rev_FC_SRL
  import MABook;
  import MABook;
  import MABook;
  import MABook;
  ...
  Regler.Aufteilung_RL_recFC_SRL aufteilung_Erzeuger annotation (Placement(transformation(extent={{8,76},{40,106}})));
  ...
  Regler.Aufteilung_RL_recFC_SRL aufteilung_Erzeuger1 annotation (Placement(transformation(extent={{16,-180},{48,-150}})));
...
equation
  ...
  connect(SOC_LiIon, aufteilung_Erzeuger.SOC) annotation (Line(points={{-104,202},{24.16,202},{24.16,107.95}}, color={0,0,127}));
  connect(aufteilung_Erzeuger1.SOC, SOC_LiIon) annotation (Line(points={{32.16,-148.05},{32.16,202},{-104,202}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(extent={{-100,-200},{100,220}})), Icon(coordinateSystem(extent={{-100,-200},{100,220}})),
    Documentation(info="<html>
<p>Betriebsf&uuml;hrung und &quot;Fallregler&quot; f&uuml;r ein virtuelles Kraftwerk mit einer reversiblen Brennstoffzelle und Druckspeicher</p>
...
end Regler_Virtuelles_Kraftwerk_mitSpeicher_rev_FC_SRL;
