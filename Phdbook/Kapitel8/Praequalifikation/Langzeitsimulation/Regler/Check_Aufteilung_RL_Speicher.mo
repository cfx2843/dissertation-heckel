...
model Check_Aufteilung_RL_Speicher

  import MABook;
  Langzeitsimulation.Regler.Aufteilung_RL_Speicher aufteilung_RL_Speicher annotation (Placement(transformation(extent={{16,-46},{122,78}})));
...
equation
  ...
  connect(const2.y, aufteilung_RL_Speicher.P_max) annotation (Line(points={{-57,-16},{-20,-16},{-20,-16.86},{18.12,-16.86}}, color={0,0,127}));
  connect(primaryBalancingController.P_set, aufteilung_RL_Speicher.P_RL_set) annotation (Line(
      points={{-12.2,64.2},{-12.2,31.1},{13.88,31.1},{13.88,31.5}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(aufteilung_RL_Speicher.P_RL_Angebot, primaryBalancingController.PRL_Angebot) annotation (Line(points={{14.94,64.98},{-4,64.98},{-4,84},{-48,84},{-48,72.3},{-35.3,72.3}}, color={0,127,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)));
end Check_Aufteilung_RL_Speicher;
