...
block Regler_Virtuelles_Kraftwerk_mitSpeicher_neu
  import MABook;
  import MABook;
  import MABook;
  import MABook;
  ...
  Modelica.Blocks.Interfaces.RealInput SOC_LiIon annotation (Placement(transformation(extent={{-116,178},{-92,202}}),iconTransformation(extent={{-116,178},{-92,202}})));
  parameter Real SOC_LiIon_soll=0.6 "Sollwert Füllstand des LiIon-Speichers";
  ...
  Modelica.Blocks.Sources.RealExpression SOC_soll(y=SOC_LiIon_soll) annotation (Placement(transformation(extent={{-108,212},{-88,232}})));
  Modelica.Blocks.Math.Add add1(k2=-1) annotation (Placement(transformation(extent={{-64,196},{-44,216}})));
  Modelica.Blocks.Logical.GreaterEqualThreshold greaterEqualThreshold1
                                                                      annotation (Placement(transformation(extent={{-26,196},{-6,216}})));
  Modelica.Blocks.Logical.GreaterThreshold      greaterThreshold      annotation (Placement(transformation(extent={{-72,114},{-52,134}})));
  Modelica.Blocks.Logical.Switch switch3 annotation (Placement(transformation(extent={{-34,138},{-14,158}})));
  Modelica.Blocks.Logical.LogicalSwitch logicalSwitch annotation (Placement(transformation(extent={{28,166},{48,186}})));
  Modelica.Blocks.Sources.BooleanExpression booleanExpression annotation (Placement(transformation(extent={{4,198},{24,218}})));
equation
  ...
  connect(SOC_soll.y, add1.u1) annotation (Line(points={{-87,222},{-76,222},{-76,212},{-66,212}}, color={0,0,127}));
  connect(SOC_LiIon, add1.u2) annotation (Line(points={{-104,190},{-86,190},{-86,200},{-66,200}}, color={0,0,127}));
  connect(add1.y, greaterEqualThreshold1.u) annotation (Line(points={{-43,206},{-28,206}}, color={0,0,127}));
  connect(PRL_set, greaterThreshold.u) annotation (Line(points={{-102,90},{-88,90},{-88,124},{-74,124}}, color={0,127,127}));
  ...
  connect(greaterThreshold.y, switch3.u2) annotation (Line(points={{-51,124},{-44,124},{-44,148},{-36,148}}, color={255,0,255}));
  ...
  connect(greaterThreshold.y, logicalSwitch.u2) annotation (Line(points={{-51,124},{-2,124},{-2,176},{26,176}}, color={255,0,255}));
  connect(booleanExpression.y, logicalSwitch.u1) annotation (Line(points={{25,208},{26,208},{26,184}}, color={255,0,255}));
  connect(greaterEqualThreshold1.y, logicalSwitch.u3) annotation (Line(points={{-5,206},{2,206},{2,168},{26,168}}, color={255,0,255}));
  connect(booleanExpression.y, switch1.u2) annotation (Line(points={{25,208},{30,208},{30,206},{36,206},{36,198},{52,198},{52,84},{-30,84}}, color={255,0,255}));
  annotation (Diagram(coordinateSystem(extent={{-100,-200},{100,220}})), Icon(coordinateSystem(extent={{-100,-200},{100,220}})));
end Regler_Virtuelles_Kraftwerk_mitSpeicher_neu;
