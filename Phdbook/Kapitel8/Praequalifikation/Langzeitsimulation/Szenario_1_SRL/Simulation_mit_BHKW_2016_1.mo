...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(Energie_gesetzt_BHKW.u, bHKW_statisch.electricPowerIn) annotation (Line(points={{-70,-180},{-60,-180},{-60,-211},{-9.22667,-211}}, color={0,0,127}));
  ...
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-121.2,13},{-183.6,13},{-183.6,6},{-202,6}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-177,-52},{-200,-52}},                       color={0,0,127}));
  connect(Energie_Spotmarkt.y,Spotmarktangebot)  annotation (Line(points={{-53,-154},{-110,-154}}, color={0,0,127}));
  connect(Energie_gesetzt_BHKW.y, Energie_BHKW) annotation (Line(points={{-93,-180},{-142,-180}}, color={0,0,127}));
  connect(Zuverlaessigkeit_Waerme.Percentage, Sicherheit_Waerme) annotation (Line(
      points={{-39.2,-267},{-50.6,-267},{-50.6,-266},{-66,-266}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  annotation (
