within Phdbook.Kapitel8.Praequalifikation.Langzeitsimulation.Szenario_1_PRL;
model Simulation_mit_BHKW_2017_2
  import MABook;
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(Data_7.y[4],Wind_7. v_wind) annotation (Line(points={{39,78},{40,78},{40,77.8},{45.6,77.8}}, color={0,0,127}));
  ...
  connect(Wind_1.epp,ElectricGrid. epp) annotation (Line(
      ...
      color={0,135,135},
      thickness=0.5));
  connect(regler_Virtuelles_Kraftwerk.PRL_set, primaryBalancingController.P_set) annotation (Line(points={{79.56,-106.24},{91.39,-106.24},{91.39,-102.2},{140.2,-102.2}},   color={0,127,127}));
  ...
  connect(G.y, regler_Virtuelles_Kraftwerk.PRL_Angebot) annotation (Line(points={{318,-119},{200,-119},{200,-115.92},{79.56,-115.92}},   color={0,0,127}));
  ...
  connect(Summe_Leistung_gesetzt.y, Energie_gesetzt.u) annotation (Line(points={{-127.02,-52},{-154,-52}},                       color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[1], Wind_9.P_set) annotation (Line(points={{-114,-55.78},{-56,-55.78},{-56,4},{-3.9,4},{-3.9,36.3},{45.2,36.3}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[2], Wind_7.P_set) annotation (Line(points={{-114,-54.94},{-58,-54.94},{-58,0},{-8,0},{-8,70.3},{45.2,70.3}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[3], Wind_5.P_set) annotation (Line(points={{-114,-54.1},{-62,-54.1},{-62,-10},{-18,-10},{-18,106.3},{47.2,106.3}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[4], Wind_3.P_set) annotation (Line(points={{-114,-53.26},{-68,-53.26},{-68,-22},{-30,-22},{-30,140.3},{47.2,140.3}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[5], Wind_1.P_set) annotation (Line(points={{-114,-52.42},{-74,-52.42},{-74,-30},{-40,-30},{-40,170.3},{47.2,170.3}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[6], PV_4.P_set) annotation (Line(points={{-114,-51.58},{-78,-51.58},{-78,-46},{-48,-46},{-48,194},{57.4,194},{57.4,197.5}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[7], PV_18.P_set) annotation (Line(points={{-114,-50.74},{-82,-50.74},{-82,-58},{-56,-58},{-56,227.5},{57.4,227.5}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[8], PV_15.P_set) annotation (Line(points={{-114,-49.9},{-86,-49.9},{-86,-60},{-66,-60},{-66,259.5},{57.4,259.5}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[9], PV_13.P_set) annotation (Line(points={{-114,-49.06},{-92,-49.06},{-92,-64},{-76,-64},{-76,293.5},{57.4,293.5}}, color={0,0,127}));
  connect(Summe_Leistung_gesetzt.u[10], PV_11.P_set) annotation (Line(points={{-114,-48.22},{-96,-48.22},{-96,-72},{-86,-72},{-86,325.5},{57.4,325.5}}, color={0,0,127}));
  connect(Energie_gesetzt_BHKW.u, bHKW_statisch.electricPowerIn) annotation (Line(points={{-144,-210},{-68,-210},{-68,-180},{-60,-180},{-60,-211},{-9.22667,-211}}, color={0,0,127}));
  connect(greaterThreshold.y, Zuverlaessigkeit_Waerme.Erfuellt) annotation (Line(points={{-7,-256},{-12,-256},{-12,-255.2},{-141.2,-255.2}},color={255,0,255}));
  ...
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{320,-185},{318,-185},{318,-142}},            color={0,0,127}));
  connect(Energie_gesetzt1.u, regler_Virtuelles_Kraftwerk.P_sum_AP) annotation (Line(points={{-146,-122},{-72,-122},{-72,-145.84},{-2.34,-145.84}}, color={0,0,127}));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-177,-52},{-194,-52},{-194,-66},{-218,-66}}, color={0,0,127}));
  connect(Energie_gesetzt_BHKW.y,Energie_BHKW)  annotation (Line(points={{-167,-210},{-192,-210},{-192,-226},{-218,-226}},
                                                                                                  color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-121.2,13},{-159.6,13},{-159.6,-4},{-180,-4}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Zuverlaessigkeit_Waerme.Percentage,Sicherheit_Waerme)  annotation (Line(
      points={{-163.2,-261},{-188.6,-261},{-188.6,-284},{-238,-284}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt1.y, Spotmarktangebot) annotation (Line(points={{-169,-122},{-190,-122},{-190,-162},{-210,-162}}, color={0,0,127}));
  annotation (
...
end Simulation_mit_BHKW_2017_2;
