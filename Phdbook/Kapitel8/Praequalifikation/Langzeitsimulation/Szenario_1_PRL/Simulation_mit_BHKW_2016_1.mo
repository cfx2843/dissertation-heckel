...
model Simulation_mit_BHKW_2016_1
  import MABook;
...
protected
  ...
  TransiEnt.Basics.Tables.GenericDataTable Frequenzdaten(
    ...
    relativepath=":/Daten/2016/Frequenz2016.txt",
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Frequenz2016.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_11(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_11.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_1(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_1.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,178})));
  TransiEnt.Basics.Tables.GenericDataTable Data_3(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_3.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,148})));
  TransiEnt.Basics.Tables.GenericDataTable Data_5(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_5.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,114})));
  TransiEnt.Basics.Tables.GenericDataTable Data_7(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_7.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,78})));
  TransiEnt.Basics.Tables.GenericDataTable Data_9(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_9.txt",
    shiftTime=0) annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=0,
        origin={26,44})));
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_13(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_13.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_15(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_15.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_18(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_18.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Data_20(
    ...
    columns={2,3,4,5},
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/2016/Daten16_20.txt",
  ...
  TransiEnt.Basics.Tables.GenericDataTable Prognose_Optimierung_S1(
    ...
    relativepath="",
    use_absolute_path=true,
    absolute_path="C:/Users/MIni-Tower/Git/ducci/Daten/Prognose_2016_S1.txt",
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(Zuverlaessigkeit.Erfuellt, regler_Virtuelles_Kraftwerk.PRL_erfuellt) annotation (Line(points={{-161.2,18.8},{-52.6,18.8},{-52.6,17.84},{-5.46,17.84}},color={255,0,255}));
  connect(Summe_Leistung_gesetzt.y, Energie_gesetzt.u) annotation (Line(points={{-119.02,-52},{-162,-52}},                       color={0,0,127}));
  ...
  connect(Energie_gesetzt_BHKW.u, bHKW_statisch.electricPowerIn) annotation (Line(points={{-160,-210},{-60,-210},{-60,-211},{-9.22667,-211}}, color={0,0,127}));
  connect(greaterThreshold.y, Zuverlaessigkeit_Waerme.Erfuellt) annotation (Line(points={{-7,-256},{-12,-256},{-12,-261.2},{-157.2,-261.2}},color={255,0,255}));
  ...
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{320,-173},{318,-173},{318,-142},{318,-142}}, color={0,0,127}));
  connect(regler_Virtuelles_Kraftwerk.P_sum_AP, Energie_gesetzt1.u) annotation (Line(
      points={{-2.34,-145.84},{-80.17,-145.84},{-80.17,-146},{-158,-146}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-185,-52},{-220,-52},{-220,-50},{-244,-50}}, color={0,0,127}));
  connect(Energie_gesetzt_BHKW.y,Energie_BHKW)  annotation (Line(points={{-183,-210},{-244,-210}},color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-183.2,13},{-185.6,13},{-185.6,12},{-206,12}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Zuverlaessigkeit_Waerme.Percentage,Sicherheit_Waerme)  annotation (Line(
      points={{-179.2,-267},{-214.6,-267},{-214.6,-268},{-264,-268}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt1.y, Spotmarktangebot) annotation (Line(points={{-181,-146},{-236,-146}}, color={0,0,127}));
  annotation (
...
end Simulation_mit_BHKW_2016_1;
