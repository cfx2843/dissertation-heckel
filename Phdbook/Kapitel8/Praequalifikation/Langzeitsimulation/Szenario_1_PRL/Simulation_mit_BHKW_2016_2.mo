...
model Simulation_mit_BHKW_2016_2
  import MABook;
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(Zuverlaessigkeit.Erfuellt, regler_Virtuelles_Kraftwerk.PRL_erfuellt) annotation (Line(points={{-161.2,22.8},{-52.6,22.8},{-52.6,17.84},{-5.46,17.84}},color={255,0,255}));
  connect(Summe_Leistung_gesetzt.y, Energie_gesetzt.u) annotation (Line(points={{-119.02,-52},{-136,-52},{-136,-50},{-166,-50}}, color={0,0,127}));
  ...
  connect(Energie_gesetzt_BHKW.u, bHKW_statisch.electricPowerIn) annotation (Line(points={{-158,-202},{-66,-202},{-66,-210},{-58,-210},{-58,-211},{-9.22667,-211}}, color={0,0,127}));
  connect(greaterThreshold.y, Zuverlaessigkeit_Waerme.Erfuellt) annotation (Line(points={{-7,-256},{-12,-256},{-12,-257.2},{-155.2,-257.2}},color={255,0,255}));
  ...
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{320,-195},{318,-195},{318,-142},{318,-142}}, color={0,0,127}));
  connect(Energie_gesetzt1.u, regler_Virtuelles_Kraftwerk.P_sum_AP) annotation (Line(points={{-150,-144},{-82,-144},{-82,-145.84},{-2.34,-145.84}}, color={0,0,127}));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-189,-50},{-232,-50},{-232,-48},{-256,-48}}, color={0,0,127}));
  connect(Energie_gesetzt_BHKW.y,Energie_BHKW)  annotation (Line(points={{-181,-202},{-250,-202},{-250,-208},{-256,-208}},
                                                                                                  color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-183.2,17},{-197.6,17},{-197.6,14},{-218,14}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Zuverlaessigkeit_Waerme.Percentage,Sicherheit_Waerme)  annotation (Line(
      points={{-177.2,-263},{-226.6,-263},{-226.6,-266},{-276,-266}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt1.y, Spotmarktangebot) annotation (Line(points={{-173,-144},{-248,-144}}, color={0,0,127}));
  annotation (
...
end Simulation_mit_BHKW_2016_2;
