...
model Simulation_mit_REVeLY_2017_2
...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(regler_Virtuelles_Kraftwerk_mitLiIon.PRL_erfuellt, Zuverlaessigkeit.Erfuellt) annotation (Line(points={{-4.68,13.1048},{-16.78,13.1048},{-16.78,10.8},{-179.2,10.8}}, color={255,0,255}));
  ...
  connect(P_AP.u, regler_Virtuelles_Kraftwerk_mitLiIon.P_sum_AP) annotation (Line(points={{-160,-82},{-160,-80},{-104,-80},{-104,-149.486},{-1.56,-149.486}},
                                                                                                                                                  color={0,0,127}));
  ...
  connect(rev_PEM_FC_statisch.P_max_FC, regler_Virtuelles_Kraftwerk_mitLiIon.Max_P_unload_LiIon) annotation (Line(
      ...
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_Brennstoffzelle.u, rev_PEM_FC_statisch.electricPowerIn) annotation (Line(points={{-164,-140},{-18,-140},{-18,-163.6},{21.2,-163.6}},                      color={0,0,127}));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{118,-219},{118,-196}}, color={0,0,127}));
  connect(zyklanzahl_von_SOC.SOC, rev_PEM_FC_statisch.SOC) annotation (Line(points={{-159.1,-219.9},{42.4,-219.9},{42.4,-175.4}}, color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-201.2,5},{-251.6,5},{-251.6,8},{-266,8}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-187,-32},{-238,-32},{-238,-32},{-280,-32}},
                                                                                           color={0,0,127}));
  connect(P_AP.y,Spotmarktangebot)  annotation (Line(points={{-183,-82},{-248,-82},{-248,-88},{-312,-88}},
                                                                                      color={0,0,127}));
  connect(Energie_Brennstoffzelle.y,Energie_Brennstoff)  annotation (Line(points={{-187,-140},{-248,-140},{-248,-186},{-308,-186}},
                                                                                                           color={0,0,127}));
  connect(zyklanzahl_von_SOC.Zyklen,Zyklenzahl)  annotation (Line(points={{-182.2,-220},{-250,-220},{-250,-220},{-306,-220}},
                                                                                                                           color={0,0,127}));
  annotation (
...
end Simulation_mit_REVeLY_2017_2;
