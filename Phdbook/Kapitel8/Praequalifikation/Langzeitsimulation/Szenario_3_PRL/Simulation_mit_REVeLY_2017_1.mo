...
equation
 // prognosegenauigkeit.PowerIn=-ElectricGrid.epp.P;
  ...
  connect(zyklanzahl_von_SOC.SOC, regler_Virtuelles_Kraftwerk_mitLiIon.SOC_LiIon) annotation (Line(points={{-119.1,-221.9},{64,-221.9},{64,-173.4},{96,-173.4},{96,-144.457},{79.56,-144.457}},color={0,0,127}));
  connect(Energie_Brennstoffzelle.u, rev_PEM_FC_statisch.electricPowerIn) annotation (Line(points={{-112,-160},{-24,-160},{-24,-161.6},{29.2,-161.6}},color={0,0,127}));
  connect(P_AP.u, regler_Virtuelles_Kraftwerk_mitLiIon.P_sum_AP) annotation (Line(points={{-114,-122},{-16,-122},{-16,-149.486},{-1.56,-149.486}},
                                                                                                                                                 color={0,0,127}));
  connect(Prognose_Optimierung_S1.y[1], G.u) annotation (Line(points={{120,-227},{120,-196},{118,-196}},
                                                                                              color={0,0,127}));
  connect(Zuverlaessigkeit.Percentage,Sicherheit)  annotation (Line(
      points={{-215.2,31},{-251.6,31},{-251.6,34},{-266,34}},
      color={0,135,135},
      pattern=LinePattern.Dash));
  connect(Energie_gesetzt.y,Einspeisung)  annotation (Line(points={{-187,-32},{-238,-32},{-238,-6},{-280,-6}},
                                                                                           color={0,0,127}));
  connect(P_AP.y,Spotmarktangebot)  annotation (Line(points={{-137,-122},{-248,-122},{-248,-126},{-308,-126}},
                                                                                      color={0,0,127}));
  connect(Energie_Brennstoffzelle.y,Energie_Brennstoff)  annotation (Line(points={{-135,-160},{-308,-160}},color={0,0,127}));
  connect(zyklanzahl_von_SOC.Zyklen,Zyklenzahl)  annotation (Line(points={{-142.2,-222},{-250,-222},{-250,-194},{-306,-194}},
                                                                                                                           color={0,0,127}));
  annotation (
    ...
    __Dymola_Commands(executeCall=simulateModel(
          "MABook.Simulation_Statisch.Usecase_4_PRL.Simulation_mit_REVeLY_2017",
          stopTime=31536000,
          numberOfIntervals=0,
          outputInterval=10.000008,
          tolerance=0.05,
          resultFile="Simulation_mit_REVeLY_2017")),
