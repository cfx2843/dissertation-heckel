...
//________________________________________________________________________________//
  ...
  //Air
  final parameter Modelica.Units.SI.MolarMass M_i_air[airType.nc_propertyCalculation]=TransiEnt.Basics.Functions.GasProperties.getMolarMasses_idealGas(airType, airType.nc_propertyCalculation) "[O2, N2] Air molar masses";
  //Fuel
  final parameter Modelica.Units.SI.MolarMass M_i_fuel[FuelMedium.nc_propertyCalculation]=TransiEnt.Basics.Functions.GasProperties.getMolarMasses_idealGas(FuelMedium, FuelMedium.nc_propertyCalculation) "Fuel molar masses";
  //Exhaust
  final parameter Modelica.Units.SI.MolarMass M_i_exh[ExhaustGas.nc_propertyCalculation]=TransiEnt.Basics.Functions.GasProperties.getMolarMasses_idealGas(ExhaustGas, ExhaustGas.nc_propertyCalculation) "[H2O, CO2, CO, H2, O2, NO, NO2, SO2, N2] Exhaust molar masses";
  ...
  final parameter Modelica.Units.SI.MassFraction[airType.nc - 1] xi_air=airType.xi_default "[H2O, N2, O2] Air components mass fraction";
  ...
  //Flow composition
protected
  Modelica.Units.SI.MassFraction xi_fuel[FuelMedium.nc - 1](start=FuelMedium.xi_default) "Mass fraction of fuel components";
  Modelica.Units.SI.MassFraction xi_exh[ExhaustGas.nc - 1](start=zeros(ExhaustGas.nc - 1)) "[H2O, CO2, CO, H2, O2, NO, NO2, SO2, N2] Mass fraction of flue components";
