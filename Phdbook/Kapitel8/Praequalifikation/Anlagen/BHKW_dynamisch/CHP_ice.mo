...
//________________________________________________________________________________//
  ...
  // _____________________________________________
  extends Phdbook.Kapitel8.Praequalifikation.Anlagen.BHKW_dynamisch.PartialCHP(p_init=simCenter.p_nom[1], motorblock(redeclare model HeatFlowModel = TransiEnt.Components.Gas.Engines.HeatFlow.SimpleHeatFlow));
