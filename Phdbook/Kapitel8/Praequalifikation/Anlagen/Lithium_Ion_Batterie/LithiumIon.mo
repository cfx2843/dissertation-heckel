...
//________________________________________________________________________________//
  extends TransiEnt.Storage.Base.GenericStorageParameters(
     E_start=E_min, E_max=P_max_unload*24*3600, E_min=0.3*E_max, P_max_unload=420, P_grad_max=P_max_unload/0.1, eta_unload=0.95, eta_load=0.95,selfDischargeRate=0.1/100/3600,
...
<p>Typical parameters of lithium-ion battery.</p>
