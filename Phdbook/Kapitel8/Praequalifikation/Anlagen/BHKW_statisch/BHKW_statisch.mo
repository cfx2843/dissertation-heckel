...
block BHKW_statisch
  ...
  CHP_ice_static               CHP(redeclare BHKW_dynamisch.TCG_2016_V16_C Specification(
  ...
  BHKW_dynamisch.ControllerExtP_el controllerExtP_el(redeclare BHKW_dynamisch.TCG_2016_V16_C Specification(
      P_el_max=P_el_n,
      P_el_min=0,
      T_return_max=373.15,
      reactionTime=0,
  ...
  Modelica.Blocks.Sources.Constant Gasproduzent(k=m_dot)
        ...
        rotation=0,
        origin={-158,-10})));
  BHKW_dynamisch.Gasspeicher gasspeicher(m_max=m_Speicher) annotation (Placement(transformation(extent={{-128,-28},{-108,-8}})));
  BHKW_dynamisch.Thermisches_Management thermisches_Management(
    E_thermal(displayUnit="kWh") = 712800000,
    E_start(displayUnit="kWh"),
    Q_fermenter(displayUnit="kW") = m_dot*15218300*0.21) annotation (Placement(transformation(
        extent={{-10,-19},{10,19}},
        rotation=180,
        origin={96,71})));
  ...
  Modelica.Blocks.Math.Gain gain1(k=-1) annotation (Placement(transformation(extent={{-10,-10},{10,10}},
        rotation=270,
        origin={-62,-76})));
  Lastprofil_Waerme lastprofil_Waerme annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={206,88})));
