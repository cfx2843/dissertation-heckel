...
model CHP_ice_static "Model of a small CHP with configureable internal combustion engine"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
  extends Phdbook.Kapitel8.Praequalifikation.Anlagen.BHKW_statisch.PartialCHP_static(p_init=simCenter.p_nom[1], motorblock(redeclare model HeatFlowModel = TransiEnt.Components.Gas.Engines.HeatFlow.SimpleHeatFlow));
  ...
  Modelica.Units.SI.PressureDifference dp_total=waterPortIn.p - waterPortOut.p "Total pressure loss";
