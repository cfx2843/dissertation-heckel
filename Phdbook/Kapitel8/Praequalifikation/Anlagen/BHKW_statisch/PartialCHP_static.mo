...
partial model PartialCHP_static "Model consisting of replaceable engine and generator and control interface"
...
//________________________________________________________________________________//
  ...
  replaceable model Motorblock = Phdbook.Kapitel8.Praequalifikation.Anlagen.BHKW_statisch.Engine_idealGas_static constrainedby TransiEnt.Components.Gas.Engines.Base.PartialEngine_idealGas
                                                                                                                                                           "Engine model containing mechanic, thermal, and combustion model" annotation (Dialog(tab="General", group="Replaceable Components"), choicesAllMatching=true);
  ...
  parameter Modelica.Units.SI.Temperature T_site=290 "Average ambient temperature at plant site" annotation (Dialog(tab="General", group="Specification"));
  parameter Modelica.Units.SI.PressureDifference Delta_p_nom=1e5 "Nominal pressure drop in heat flow model" annotation (Dialog(tab="General", group="Specification"));
  parameter Modelica.Units.SI.MassFlowRate m_flow_nom=motorblock.heatFlowModel.simCenter.m_flow_nom "Nominal mass flow rate in heat flow model" annotation (Dialog(tab="General", group="Specification"));

  //Combustion
  parameter Modelica.Units.SI.SpecificEnthalpy NCV_const=40e6 "Constant value for net calorific value (set to 0 for medium dependent NCV calculation)" annotation (Dialog(tab="General", group="Combustion"));
...
public
  Modelica.Units.SI.Efficiency eta_el=motorblock.mechanicModel.eta_el "Electric efficiency";
  Modelica.Units.SI.Efficiency eta_th=motorblock.mechanicModel.eta_h - motorblock.mechanicModel.eta_el "Thermal efficiency";

  Modelica.Units.SI.Power P_el_out=epp.P "Total generated electric power";
  Modelica.Units.SI.Power P_el_set_intern=-P_el_set_intern "Set electric power";
  Modelica.Units.SI.HeatFlowRate Q_flow_out "Total generated thermal power";
  Modelica.Units.SI.HeatFlowRate Q_flow_fuel=motorblock.Q_flow_fuel "Consumed fuel thermal power (NCV)";
  Modelica.Units.SI.HeatFlowRate Q_flow_loss=motorblock.heatFlowModel.Q_flow_loss "Total loss heat flow (radiant and exhaust)";
  Modelica.Units.SI.MassFlowRate m_flow_fuel=gasPortIn.m_flow "Fuel mass flow rate";
  Modelica.Units.SI.MassFlowRate m_flow_CDE=gasPortOut.xi_outflow[2]*gasPortOut.m_flow "CDE mass flow rate";
  ...
  Modelica.Units.SI.Temperature T_supply_intern=supplyTemperatureSensor.T "Supply temperature";
  Modelica.Units.SI.Temperature T_return_intern=returnTemperatureSensor.T "Supply temperature";
...
public
  ...
  // _____________________________________________
  Engine_idealGas_static motorblock(
