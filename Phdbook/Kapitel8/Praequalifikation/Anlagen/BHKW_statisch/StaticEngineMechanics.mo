...
if switch then
  ...
  connect(mechanicalPower.mpp, mpp) annotation (Line(
      ...
      color={95,95,95},
      smooth=Smooth.None));
  connect(clutch.y, mechanicalPower.P_mech_set) annotation (Line(points={{6.6,-16},{18,-16},{18,-18},{65,-18},{65,-37.84}}, color={0,0,127}));
  connect(P_el_is, mechanicalPower.P_mech_set) annotation (Line(
      points={{-64,-112},{-18,-112},{-18,-48},{32,-48},{32,-18},{65,-18},{65,-37.84}},
      color={0,135,135},
