...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Velocity v_fullLoad=12 "nominal wind speed";
  ...
  parameter Modelica.Units.SI.Velocity v_wind_small=simCenter.v_wind_small "Small wind velocity with neglectable power";
  ...
  final parameter Modelica.Units.SI.Density rho=1.225;
...
public
  ...
  Modelica.Blocks.Tables.CombiTable1Dv lambdaOpt(
    table=turbineCharacteristics.lambdaOpt,
    columns={2},
