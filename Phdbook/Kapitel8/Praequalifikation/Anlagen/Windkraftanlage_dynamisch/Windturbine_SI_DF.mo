...
//________________________________________________________________________________//
  ...
  parameter Modelica.Units.SI.Length D_Rotor=100 "Rotor diameter of wind turbine" annotation (Dialog(tab="Wind Turbine Data"));
  ...
  final parameter Modelica.Units.SI.AngularVelocity omega_n=Rotor.lambda_opt*v_fullload*2/Rotor.D;
...
public
  ...
  Modelica.Blocks.Sources.RealExpression omega_is(y=Rotor.omega)
    annotation (Placement(transformation(extent={{-54,36},{-26,54}})));
  ...
  TorqueController_modified torqueController(
    v_wind=v_wind1.y,
    ...
    v_cutIn=operationRanges.v_cutIn) annotation (Placement(transformation(rotation=0, extent={{8,38},{28,58}})));
...
equation
  ...
  connect(omega_is.y, torqueController.omega_is) annotation (Line(points={{-24.6,45},{8,45},{8,43.4545}},
                                          color={0,0,127}));
  connect(torqueController.y, Generator.tau_set) annotation (Line(points={{29,48.9091},{16.98,48.9091},{16.98,-26.75}},
                                     color={0,0,127}));
  ...
  connect(wind_fullload.y, torqueController.wind_fullload) annotation (Line(points={{-8.6,23},{-8.6,54.5},{8,54.5},{8,54.3636}}, color={0,0,127}));
    annotation (
