...
//________________________________________________________________________________//
  ...
  parameter TransiEnt.Producer.Electrical.Wind.Characteristics.RoughnessCharacteristics.OwnValue Roughness=TransiEnt.Producer.Electrical.Wind.Characteristics.RoughnessCharacteristics.OwnValue() "Roughness factor of ground for calculation of Wind velocity in different heights" annotation (__Dymola_choicesAllMatching=true, Dialog(tab="Wind speed calculation"));
