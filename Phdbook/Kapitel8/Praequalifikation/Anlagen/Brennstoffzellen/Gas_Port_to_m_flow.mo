...
protected
  ...
  TransiEnt.Basics.Interfaces.General.MassFlowRateOut massFlowRateOut annotation (Placement(transformation(extent={{90,38},{144,92}}),  iconTransformation(extent={{90,38},{144,92}})));
...
equation
  ...
  massFlowRateOut=gasPort.m_flow;
  // _____________________________________________
  //
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-160},{100,100}})),
                                                                 Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-160},{100,100}})),
