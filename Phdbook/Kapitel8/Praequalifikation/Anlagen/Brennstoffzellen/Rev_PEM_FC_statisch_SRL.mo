...
block Rev_PEM_FC_statisch_SRL
  ...
  Modelica.Blocks.Sources.RealExpression realExpression2(y=-P_el_n)                        annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-22,-96})));
  Elektrolyseur_statisch elektrolyseur_statisch(eta_ely=0.75, P_max=(0.75/0.4)*P_el_n)
                                                annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=180,
        origin={68,-6})));
...
<p><span style=\"font-family: MS Shell Dlg 2;\">Generische reversible PEM-Brennstoffzelle</span></p>
