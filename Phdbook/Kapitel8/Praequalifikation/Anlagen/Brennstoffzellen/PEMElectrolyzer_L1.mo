...
protected
  Modelica.Units.SI.MassFlowRate m_flow_H2 "H2 mass flow rate out of electrolyzer";
public
  ...
  Modelica.Units.SI.Efficiency eta_GCV(
    min=0,
    max=1) = charline.eta "Efficiency of the electrolyzer based on GCV" annotation (Dialog(group="Initialization", showStartAttribute=true));
protected
  model Outline
