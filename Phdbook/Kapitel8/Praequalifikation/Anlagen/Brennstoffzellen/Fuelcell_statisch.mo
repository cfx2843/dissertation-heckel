...
equation
  ...
  connect(Power.P_el_set, gain.u) annotation (Line(points={{64,50},{66,50},{66,42},{-74,42},{-74,0},{10,0}}, color={0,127,127}));
  annotation (Icon(coordinateSystem(preserveAspectRatio=false)), Diagram(coordinateSystem(preserveAspectRatio=false)),
    Documentation(info="<html>
<p><span style=\"font-family: MS Shell Dlg 2;\">Statisch-generische Brennstoffzelle</span></p>
