...
model PrognosisPVModule "Simple efficiency-based PV model"
...
public
  ...
  TransiEnt.Basics.Interfaces.Electrical.ElectricPowerOut MaxP_out annotation (Placement(transformation(extent={{94,-20},{134,20}}),  iconTransformation(extent={{94,-20},{134,20}})));
equation
  // _____________________________________________
  //
