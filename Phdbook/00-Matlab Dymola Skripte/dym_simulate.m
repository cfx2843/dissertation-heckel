...
%    All rights reserved.
%
%    - February 1, 2018 by Carsten Bode, TUHH:
%      added other solvers
...
% Set default structure for dsin.txt file
  Algorithm = {'deabm'    , 'lsode1'   , 'lsode2'   , 'lsodar'   , 'dopri5'    , ...
               'dopri8'   , 'grk4t'    , 'dassl'    , 'odassl'   , 'mexx'      , ...
               'euler'    , 'rkfix2'   , 'rkfix3'   , 'rkfix4'   , 'radau'     , ...
               'esdirk23a', 'esdirk34a', 'esdirk45a', 'dopri45'  , 'dopri78'   , ...
               'dopri853' , 'unknown'  , 'sharp67'  , 'sdirk34hw', 'sdirk34var', ...
               'cerk23'   , 'cerk34'   , 'cerk45'   , 'cvode'};
...
% 29 - cvode (variable order from sundials), dense output, implicit
% 30 - Euler (just for test) no dense output, explicit
