function [clusterKnoten,clusterLeitungen,erelp,erelq,SLeitungr] = Advanced_Verfahren_SimBench_NEP_function(zielAnz)
...
[~,~,Uar,dtar,~] = ConverttoPSTLFNR_SimBench(clusterLeitungen,clusterKnoten,AnzClusterLeitungen,AnzCluster);
