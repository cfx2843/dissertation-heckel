...
[Pa,Qa,Ua,dta] = ConverttoPSTLFNR(Leitungen,Knoten,AnzL,AnzK);
...
for zielAnz=10:5:125
   ...
   SLeitungencluster(loesch==1)=[];
    ...
    [Par,Qar,Uar,dtar] = ConverttoPSTLFNR(clusterLeitungen,clusterKnoten,AnzClusterLeitungen,AnzCluster);
