...
for zielAnz=30:5:125
    ...
    [Par,Qar,Uar] = ConverttoPSTLFNR(clusterLeitungen,clusterKnoten,AnzClusterLeitungen,AnzCluster);
...
grid on;
ylim([0,2]);
legend('Error for Active Power','Error for Reactive Power','FontSize',12,'Location','southwest');
