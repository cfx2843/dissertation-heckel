...
[Pa,Qa,Ua] = ConverttoPSTLFNR_SimBench(Leitungen,Knoten,AnzL,AnzK);
...
for zielAnz=210:5:600
    ...
    [Par,Qar,Uar] = ConverttoPSTLFNR_SimBench(clusterLeitungen,clusterKnoten,AnzClusterLeitungen,AnzCluster);
