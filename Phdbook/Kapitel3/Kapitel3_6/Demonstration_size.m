...
clusterKnoten=[
    1    2   0   0   1   110   -60e7    0;
    2    1   0   0   1   110    0       0;
    3    1   0   0   1   110    5e7     5e7*tand(18.2);
    4    2   0   0   1   110   -20e7    0;
    5    1   0   0   1   110    0       0;
    6    1   0   0   1   110    7e7     7e7*tand(18.2);
    ];
...
for zaehlagglo=2:n
    clusterKnotenerg=[
        zaehlKnoten+1   2   0   0   1   110   -13e7    0;
        zaehlKnoten+2   1   0   0   1   110    0       0;
        zaehlKnoten+3   1   0   0   1   110    5e7     5e7*tand(18.2);
        zaehlKnoten+4   2   0   0   1   110   -11e7    0;
        zaehlKnoten+5   1   0   0   1   110    0       0;
        zaehlKnoten+6   1   0   0   1   110    7e7     7e7*tand(18.2);];
    
    clusterKnoten=[clusterKnoten;clusterKnotenerg];
    
    
    clusterLeitungenerg=[
        zaehlKnoten-1   zaehlKnoten+2   24  110     2   4
        zaehlKnoten+1   zaehlKnoten+2   5   110     1   4;
        zaehlKnoten+2   zaehlKnoten+3   10  110     1   4;
        zaehlKnoten+2   zaehlKnoten+5   24  110     2   4;
        zaehlKnoten+4   zaehlKnoten+5   5   110     1   4;
        zaehlKnoten+5   zaehlKnoten+6   10  110     1   4;
        ];
    
    if zaehlKnoten>100
        clusterLeitungenerg2=[
            1           zaehlKnoten+2  100  110     4    4;
        ];
        
        
        clusterLeitungenerg=[clusterLeitungenerg;clusterLeitungenerg2];
    end
    
    clusterLeitungen=[clusterLeitungen;clusterLeitungenerg];
    
    
    zaehlKnoten=zaehlKnoten+6;
    zaehlLeitungen=zaehlLeitungen+5;
...
while ~konvfehler
    ...
    Knotenerhoeht(indexUa,8)=Knotenerhoeht(indexUa,8)*2;
...
%% dummy für zuhause
ModelFile=['C:/resilientee-sources/transient_library/TransiEntDevZone/Sketchbook/jh/VoltageStabilityDynamicInteraction/Nachbau.mo']; %insert your file name here
Modelname= 'Nachbau'; %Modell name
fileID=fopen('C:/resilientee-sources/transient_library/TransiEntDevZone/Sketchbook/jh/VoltageStabilityDynamicInteraction/Nachbau.mo','w');
%%
...
for i=1:nl
    ...
    elseif  load(i,2)==3% Referenzknoten
        ...
        fprintf(fileID,['Modelica.Blocks.Continuous.Integrator integrator(k=-1.23e5)annotation (Placement(transformation(        extent={{0,400},{20,380}}             )));\n']);
