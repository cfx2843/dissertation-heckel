...
model IES_dynamicload_normal_2s
  ...
  TransiEnt.Components.Electrical.Grid.PiModelComplex_advanced transmissionLine_CentralFault(
    ...
    l(displayUnit="km") = 150000) "Leitungsausfall bei 10000 s"
    annotation (Placement(transformation(extent={{-122,152},{-102,172}})));
  Modelica.Blocks.Sources.BooleanStep  BooleanFault(startTime(displayUnit="s") = 1e8,    startValue=false)
  ...
  TransiEnt.Producer.Gas.Electrolyzer.PEMElectrolyzer_L1 electrolyzer(
    usePowerPort=true,
    P_el_n=100e6,
    redeclare TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary powerBoundary(useInputConnectorQ=false, v_cp(start=110e3)),                                                whichInput=1,
  ...
  TransiEnt.Components.Boundaries.Gas.BoundaryRealGas_pTxi boundary_pTxi "Konstante Gasquelle"
                                                                         annotation (Placement(transformation(extent={{-206,-96},{-186,-76}})));
  ...
  TransiEnt.Components.Sensors.RealGas.MassFlowSensor massFlowSensor annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-42,-76})));
  Modelica.Blocks.Sources.RealExpression SetPower1(y=if La.epp.v > 109e3 then max(0, -10e8*(50 - La.epp.f)) else 0)
                                                                                    "P-Einstellung bei Überfrequenzen"                                                                                    annotation (Placement(transformation(extent={{-204,-6},{-184,14}})));
  ...
  Modelica.Blocks.Logical.Switch switch1 annotation (Placement(transformation(extent={{120,-48},{140,-28}})));
  Modelica.Blocks.Sources.BooleanStep  BooleanFault1(startTime(displayUnit="s") = 10000000)
    annotation (Placement(transformation(extent={{84,-28},{100,-12}})));
  TransiEnt.Producer.Heat.Power2Heat.ElectricBoiler.ElectricBoiler
                                                    electricBoiler(
    ...
    redeclare TransiEnt.Components.Boundaries.Heat.Heatflow_L1 heatFlowBoundary)
                     annotation (Placement(transformation(extent={{238,-206},{218,-226}})));
  Modelica.Blocks.Sources.BooleanStep  BooleanFault2(startTime(displayUnit="s") = 1000000)
 ...
 TransiEnt.Basics.Blocks.LimPID PID_TWV(
  ...
  TransiEnt.Components.Heat.PumpVLE_L1_simple pumpProd1(presetVariableType="m_flow", m_flowInput=true)
        ...
        rotation=0,
        origin={228,-269})));
  Modelica.Blocks.Sources.BooleanStep  BooleanFault3(startTime(displayUnit="s") = 1000000)
    annotation (Placement(transformation(extent={{346,-242},{330,-226}})));
  Modelica.Blocks.Logical.Switch switch3 annotation (Placement(transformation(extent={{292,-242},{272,-222}})));
  ...
  Modelica.Blocks.Logical.Switch switch4 annotation (Placement(transformation(extent={{0,-144},{20,-124}})));
  Modelica.Blocks.Sources.RealExpression set_m_flow_pump3(y=0)                       annotation (Placement(transformation(extent={{-66,-120},{-46,-100}})));
  Modelica.Blocks.Sources.BooleanStep  BooleanFault4(startTime(displayUnit="s") = 10000000)
  ...
  TransiEnt.Components.Gas.VolumesValvesFittings.Pipes.PipeFlow_L4_Simple_isoth pipe(
    ...
    diameter_i=0.25,
    N_cv=1) annotation (Placement(transformation(extent={{-180,-92},{-152,-80}})));
...
equation
  ...
  connect(L2.epp, Transformer_L2.epp_n) annotation (Line(
      points={{212,114},{212,136},{200,136}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(massFlowSensor1.gasPortIn, h2toNG.gasPortOut) annotation (Line(
      ...
      color={255,255,0},
      thickness=1.5));
  connect(SetPower1.y, electrolyzer.P_el_set) annotation (Line(points={{-183,4},{-158,4},{-158,2},{-132,2}},
                                                                                           color={0,0,127}));
  ...
  connect(electricBoiler.epp, Transformer_L2.epp_n) annotation (Line(
      points={{228,-205.8},{228,136},{200,136}},
      color={28,108,200},
      thickness=0.5));
  connect(switch2.y, electricBoiler.Q_flow_set) annotation (Line(points={{215,-170},{215,-217},{238.4,-217}},              color={0,0,127}));
  ...
  connect(hotWaterStorage.waterPortIn_prod[2], electricBoiler.fluidPortOut) annotation (Line(
      points={{26,-224.6},{26,-222},{192,-222},{192,-216},{217.8,-216}},
      color={175,0,0},
      thickness=0.5));
  connect(electricBoiler.fluidPortIn, pumpProd1.fluidPortOut) annotation (Line(
      points={{238.4,-216},{258,-216},{258,-269},{238,-269}},
      color={175,0,0},
      thickness=0.5));
  ...
  connect(boundary_pTxi.gasPort, pipe.gasPortIn) annotation (Line(
      points={{-186,-86},{-180,-86}},
      color={255,255,0},
      thickness=1.5));
  connect(pipe.gasPortOut, junction_FIS.gasPort1) annotation (Line(
      points={{-152,-86},{-148,-86},{-148,-85},{-130,-85}},
      color={255,255,0},
      thickness=1.5));
  connect(electrolyzer.epp, Transformer_L_a.epp_n) annotation (Line(
      points={{-120,8},{-120,64},{-146,64},{-146,66},{-144,66},{-144,88}},
      color={28,108,200},
      thickness=0.5));
  connect(gCVSensor_chp.gasPortIn, massFlowSensor.gasPortOut) annotation (Line(
      points={{-6,-86},{-32,-86}},
      color={255,255,0},
      thickness=1.5));
  connect(gCVSensor_chp.gasPortOut, CHP.gasPortIn) annotation (Line(
      points={{14,-86},{12,-86},{12,-90},{48,-90},{48,-74},{102,-74},{102,-92.2333}},
      color={255,255,0},
      thickness=1.5));
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}})), Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=86400,
      Interval=2,
      __Dymola_Algorithm="Dassl"));
end IES_dynamicload_normal_2s;
