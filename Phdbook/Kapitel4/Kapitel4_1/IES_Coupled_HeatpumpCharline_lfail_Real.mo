...
model IES_Coupled_HeatpumpCharline_lfail_Real
...
public
  ...
  TransiEnt.Components.Electrical.PowerTransformation.OLTC.TapChangerController OLTC_L_b(
    ...
    v_prim_n(displayUnit="kV") = 380000,
    v_sec_n(displayUnit="kV") = 110000,
    currentTap(start=0))                annotation (Placement(transformation(extent={{78,-30},{60,-12}})));
protected
...
public
  Components.ClaRa_HeatpumpCharline_Speicher_Real L1_heating(scalingFactor=1.015*30000, heatPumpElectricCharlineDG_real_testinertia(MechanicalBoundary1(change_sign=true))) annotation (Placement(transformation(extent={{-58,-82},{-30,-62}})));
  Components.ClaRa_HeatpumpCharline_Speicher_Real La_heating(scalingFactor=1.015*15000) annotation (Placement(transformation(extent={{10,-60},{38,-40}})));
  Components.ClaRa_HeatpumpCharline_Speicher_Real Lb_heating(scalingFactor=1.02*7.64*15000, heatPumpElectricCharlineDG_real_testinertia(asynchronousMotorComplex(
        x_my=1000,
        r_s=2,
        x_s=3,
        x_R1=2,
        r_R1=2))) annotation (Placement(transformation(extent={{94,-62},{122,-42}})));
  Components.ClaRa_HeatpumpCharline_Speicher_Real Lc_heating(scalingFactor=1.015*15000) annotation (Placement(transformation(extent={{176,-72},{204,-52}})));
  Components.ClaRa_HeatpumpCharline_Speicher_Real L2_heating(scalingFactor=1.015*18750) annotation (Placement(transformation(extent={{280,-14},{308,6}})));
equation
...
end IES_Coupled_HeatpumpCharline_lfail_Real;
