...
model HeatPumpElectricCharlineDG_Ideal "Electric heat pump model that produces a given heat flow via fluid ports with a charline"
...
//________________________________________________________________________________//
  ...
  // _____________________________________________
  replaceable TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary
                                                                           powerBoundary(useInputConnectorQ=false,
    useCosPhi=true,
    cosphi_boundary=0.9,                                                                                           change_sign=true) if
...
end HeatPumpElectricCharlineDG_Ideal;
