...
model ClaRa_ElectricHeatSystemBoiler_Ideal
...
parameter Real scalingFactor=30000;
  ...
  ClaRa.Components.Utilities.Blocks.LimPID PIDValve(
    ...
    y_max=electricBoiler.Q_flow_n,
    y_ref=electricBoiler.Q_flow_n,
    u_ref=273.15 + 90,
    k=5,
    Tau_i=5,
    initOption=503,
    y_start=2300,
    y_inactive=0) annotation (Placement(transformation(extent={{2,36},{14,48}})));
...
equation
  ...
  connect(gain.y, electricBoiler.Q_flow_set) annotation (Line(points={{-16.3,55},{-30,55},{-30,10}}, color={0,0,127}));
  connect(pumpVLE_L1_simple.fluidPortOut, electricBoiler.fluidPortIn) annotation (Line(
      points={{-50,2},{-44,2},{-44,0},{-39.8,0}},
      color={175,0,0},
      thickness=0.5));
  connect(electricBoiler.fluidPortOut, valveVLE_L1_1.inlet) annotation (Line(
      points={{-20,0},{0,0}},
      color={175,0,0},
      thickness=0.5));
  connect(electricBoiler.fluidPortOut, tempBeforeConsumer.port) annotation (Line(
  ...
  annotation (Icon(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}})),
    ...
    experiment(
      ...
      StopTime=3024000,
      Interval=900.00288));
end ClaRa_ElectricHeatSystemBoiler_Ideal;
