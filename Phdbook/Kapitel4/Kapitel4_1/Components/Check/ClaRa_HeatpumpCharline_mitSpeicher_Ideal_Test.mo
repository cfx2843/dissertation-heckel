...
model ClaRa_HeatpumpCharline_mitSpeicher_Ideal_Test
 ...
 TransiEnt.Basics.Blocks.LimPID PID_TWV(
  ...
  TransiEnt.Consumer.Heat.ThermalHeatConsumer_L3.ThermalHeatConsumer_L3 thermalHeatConsumer_CHP(
    ...
    redeclare TransiEnt.Consumer.Heat.ThermalHeatConsumer_L3.Base.ConstructionData.EnEV_Roof matLayRoof) annotation (Placement(transformation(
        ...
        rotation=180,
        origin={-51,52})));
  Modelica.Blocks.Sources.Constant ScaleFactor(k=scalingFactor*33000)           annotation (Placement(transformation(extent={{-54,-62},{-34,-42}})));
  ...
  Phdbook.Kapitel4.Kapitel4_1.Components.HeatPumpElectricCharlineDG_Ideal heatPumpElectricCharlineDG(
    ...
    redeclare TransiEnt.Components.Boundaries.Electrical.ComplexPower.PQBoundary powerBoundary(
      ...
      cosphi_boundary=0.9,
      change_sign=true) "PowerBoundary for ActivePowerPort") annotation (Placement(transformation(extent={{180,-6},{200,14}})));
  ...
  Phdbook.Kapitel4.Kapitel4_1.Components.LimPIDDG PID_CHP1(
    ...
    ramp(
      ...
      duration=100000,
      offset=5,
      startTime=2010000)) "It is necessary to change the ramp parameters, if a different start time is chosen." annotation (Placement(transformation(extent={{76,60},{96,80}})));
equation
  ...
  connect(heatPumpElectricCharlineDG.waterPortIn, tempBeforeCons2.port) annotation (Line(
      ...
      color={175,0,0},
      thickness=0.5));
  connect(heatPumpElectricCharlineDG.epp, electricGrid.epp) annotation (Line(
      points={{200,4},{202,4},{202,22},{178,22},{178,48}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(PID_CHP1.y, heatPumpElectricCharlineDG.Q_flow_set) annotation (Line(points={{97,70},{128,70},{128,66},{162,66},{162,4},{180,4}}, color={0,0,127}));
...
end ClaRa_HeatpumpCharline_mitSpeicher_Ideal_Test;
