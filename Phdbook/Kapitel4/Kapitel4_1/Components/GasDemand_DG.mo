...
model GasDemand_DG "Model for describing the average volume flow of natural gas"
...
//________________________________________________________________________________//
  ...
  extends TransiEnt.Basics.Tables.GasGrid.GenericGasVolumeFlowDataTable(relativepath="/gas/NaturalGasVolumeFlow_RingSupplyLineHHReitbrook_2009_2011_Average_Monotonic.txt", datasource=TransiEnt.Basics.Tables.DataPrivacy.isPublic);
