...
model IES_Electrolyzer_lfail_ideal
...
public
  Modelica.Blocks.Sources.BooleanStep  BooleanFault(startTime(displayUnit="s") = 2085000)
...
public
  Components.Electrolyzer_Ideal L1_electrolyzer(scalingFactor=1.015*30000, electrolyzer(P_el_n=200e6)) annotation (Placement(transformation(extent={{-58,-82},{-30,-62}})));
  Components.Electrolyzer_Ideal La_electrolyzer(scalingFactor=1.015*15000, electrolyzer(P_el_n=120e6)) annotation (Placement(transformation(extent={{10,-58},{38,-38}})));
  Components.Electrolyzer_Ideal Lb_electrolyzer(scalingFactor=1.02*7.64*15000, electrolyzer(P_el_n=650e6)) annotation (Placement(transformation(extent={{94,-62},{122,-42}})));
public
  Components.Electrolyzer_Ideal Lc_electrolyzeur(scalingFactor=1.015*15000, electrolyzer(P_el_n=120e6)) annotation (Placement(transformation(extent={{176,-72},{204,-52}})));
  Components.Electrolyzer_Ideal L2_electrolyzer(scalingFactor=1.015*18750, electrolyzer(P_el_n=150e6)) annotation (Placement(transformation(extent={{282,-14},{310,6}})));
equation
  ...
  connect(transmissionLine_Southern_2.epp_p,transmissionLine_Southern_1. epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(L1_electrolyzer.epp, OLTC_L1.epp) annotation (Line(
      points={{-57.8,-76.6},{-66,-76.6},{-66,-50},{-78,-50}},
      color={28,108,200},
      thickness=0.5));
  connect(La_electrolyzer.epp, Transformer_L_a.epp_n) annotation (Line(
      points={{10.2,-52.6},{-10,-52.6},{-10,-8}},
      color={28,108,200},
      thickness=0.5));
  connect(Lb_electrolyzer.epp, OLTC_L_b.epp) annotation (Line(
      points={{94.2,-56.6},{84,-56.6},{84,-21},{78,-21}},
      color={28,108,200},
      thickness=0.5));
  connect(Lc_electrolyzeur.epp, Transformer_L_c.epp_n) annotation (Line(
      points={{176.2,-66.6},{156,-66.6},{156,-8}},
      color={28,108,200},
      thickness=0.5));
  connect(L2_electrolyzer.epp, Transformer_L2.epp_n) annotation (Line(
      points={{282.2,-8.6},{276,-8.6},{276,40},{264,40}},
      color={28,108,200},
      thickness=0.5));
  annotation (
    Diagram(coordinateSystem(extent={{-160,-100},{320,120}}), graphics={Text(
        ...
        Text(
          extent={{0,-78},{300,-104}},
          lineColor={28,108,200},
          textString="Simulation needs to be started at a time with low load for an easy initialization.")}),
...
end IES_Electrolyzer_lfail_ideal;
