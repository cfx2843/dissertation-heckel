...
model IES_Coupled_HeatpumpCharline_lfail_Ideal
...
public
  Components.ClaRa_HeatpumpCharline_Speicher_Ideal L1_heating(scalingFactor=1.015*30000, heatPumpElectricCharlineDG(powerBoundary(cosphi_boundary=0.9))) annotation (Placement(transformation(extent={{-58,-82},{-30,-62}})));
public
  Components.ClaRa_HeatpumpCharline_Speicher_Ideal La_heating(scalingFactor=1.015*15000, heatPumpElectricCharlineDG(powerBoundary(cosphi_boundary=0.9))) annotation (Placement(transformation(extent={{10,-58},{38,-38}})));
public
  Components.ClaRa_HeatpumpCharline_Speicher_Ideal Lb_heating(scalingFactor=1.02*7.64*15000, heatPumpElectricCharlineDG(powerBoundary(cosphi_boundary=0.9))) annotation (Placement(transformation(extent={{94,-62},{122,-42}})));
  Components.ClaRa_HeatpumpCharline_Speicher_Ideal Lc_heating(scalingFactor=1.015*15000, heatPumpElectricCharlineDG(powerBoundary(cosphi_boundary=0.9))) annotation (Placement(transformation(extent={{176,-72},{204,-52}})));
  Components.ClaRa_HeatpumpCharline_Speicher_Ideal L2_heating(scalingFactor=1.015*18750, heatPumpElectricCharlineDG(powerBoundary(cosphi_boundary=0.9))) annotation (Placement(transformation(extent={{280,-14},{308,6}})));
equation
...
end IES_Coupled_HeatpumpCharline_lfail_Ideal;
