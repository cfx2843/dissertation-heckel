...
model IES_Compressor_lfail_real
  ...
  Modelica.Blocks.Sources.BooleanStep  BooleanFault(startTime(displayUnit="s") = 21000)
...
public
  ...
  Components.Compressorstation_DG_real L1_Compressor(asynchronousMotor(P_n=100e6), constantInertia(P_n=100000000, J=100e6*12/(100*Modelica.Constants.pi)^2)) annotation (Placement(transformation(extent={{-56,-112},{-30,-88}})));
  Components.Compressorstation_DG_real La_Compressor(
    gain(k=2),
    asynchronousMotor(P_n=200e6),
    constantInertia(J=200e6*12/(100*Modelica.Constants.pi)^2)) annotation (Placement(transformation(extent={{34,-86},{60,-62}})));
  Components.Compressorstation_DG_real Lb_Compressor(
    gain(k=7),
    asynchronousMotor(
      P_n=700e6,
      r_s=2,
      ...
      x_R1=2,
      r_R1=2),
    constantInertia(P_n=700000000, J=700e6*12/(100*Modelica.Constants.pi)^2)) annotation (Placement(transformation(extent={{100,-72},{126,-48}})));
  Components.Compressorstation_DG_real Lc_Compressor(asynchronousMotor(P_n=100e6), constantInertia(P_n=100000000, J=100e6*12/(100*Modelica.Constants.pi)^2)) annotation (Placement(transformation(extent={{160,-64},{186,-40}})));
  Components.Compressorstation_DG_real L2_Compressor(
    gain(k=1.3),
    asynchronousMotor(P_n=150e6),
    constantInertia(P_n=150000000, J=150e6*12/(100*Modelica.Constants.pi)^2)) annotation (Placement(transformation(extent={{280,-24},{306,0}})));
equation
  ...
  connect(transmissionLine_Southern_2.epp_p, transmissionLine_Southern_1.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(L1_Compressor.epp, OLTC_L1.epp) annotation (Line(
      points={{-55.8,-99.2},{-62,-99.2},{-62,-50},{-74,-50}},
      color={28,108,200},
      thickness=0.5));
  connect(La_Compressor.epp, Transformer_L_a.epp_n) annotation (Line(
      points={{34.2,-73.2},{34.2,-74},{-6,-74},{-6,-8}},
      color={28,108,200},
      thickness=0.5));
  connect(Lb_Compressor.epp, OLTC_L_b.epp) annotation (Line(
      points={{100.2,-59.2},{100.2,-40},{92,-40},{92,-21},{82,-21}},
      color={28,108,200},
      thickness=0.5));
  connect(Lc_Compressor.epp, Transformer_L_c.epp_n) annotation (Line(
      points={{160.2,-51.2},{160,-16},{160,-8}},
      color={28,108,200},
      thickness=0.5));
  connect(L2_Compressor.epp, Transformer_L2.epp_n) annotation (Line(
      points={{280.2,-11.2},{280.2,40},{268,40}},
      color={28,108,200},
      thickness=0.5));
  annotation (
    Diagram(coordinateSystem(extent={{-180,-140},{320,120}}), graphics={Text(
          extent={{6,26},{52,18}},
        ...
        Text(
          extent={{4,-98},{304,-124}},
          lineColor={28,108,200},
          textString="Starttime cannot be changed as the Tables are only calculated from 0-30000")}),
    Icon(coordinateSystem(extent={{-180,-140},{320,120}})),
    experiment(
      StopTime=30000,
      Interval=1,
