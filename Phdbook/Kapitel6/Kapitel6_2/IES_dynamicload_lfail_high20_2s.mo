...
model IES_dynamicload_lfail_high20_2s
  ...
  Modelica.Blocks.Sources.BooleanStep  BooleanFault(startTime(displayUnit="s") = 10000,  startValue=false)
  ...
  Modelica.Blocks.Sources.Step chpinput(
    height=0,
    offset=0,
    startTime=100)    annotation (Placement(transformation(extent={{80,8},{100,28}})));
  ...
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex La(
    ...
    beta_t=2.5,
    v_n(displayUnit="kV") = 220000,
    P_n(displayUnit="MW") = 1.2*101.5e6,
    Q_n=1.2*50.75e6)
                 annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
  ...
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex Lb(
    ...
    beta_t=10,
    v_n(displayUnit="kV") = 220000,
    P_n(displayUnit="MW") = 1.2*1522.5e6,
    Q_n=1.2*558.25e6)
                  annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
  ...
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex Lc(
    ...
    v_n(displayUnit="kV") = 220000,
    Q_n=1.2*50.75e6,
    P_n(displayUnit="MW") = 1.2*100.5e6)
                                       annotation (Placement(transformation(
        extent={{-11,-11},{11,11}},
        rotation=-90,
        origin={121,57})));
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex L2(
    ...
    beta_t=2.5,
    v_n(displayUnit="kV") = 220000,
    P_n(displayUnit="MW") = 1.2*126.875e6,
    Q_n=1.2*76.125e6)
                  annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
  ...
  TransiEnt.Components.Heat.PumpVLE_L1_simple pumpGrid(presetVariableType="m_flow", m_flowInput=true) "Regelung des Masseflusses zum Wärmeverbraucher."
                                                                                                      annotation (Placement(transformation(
        extent={{-10,10},{10,-10}},
        rotation=180,
        origin={-92,-204})));
...
equation
  ...
  connect(chpinput.y, switch1.u1) annotation (Line(points={{101,18},{118,18},{118,-30}}, color={0,0,127}));
  ...
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{-204,-94},{-384,-130}},
          lineColor={28,108,200},
          textString="IES-Modell für einen Leitungsausfall bei t=10000 s unter 1.2 x Normallast.")}),
                                                                         Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=86400,
      Interval=2,
      __Dymola_Algorithm="Dassl"));
end IES_dynamicload_lfail_high20_2s;
