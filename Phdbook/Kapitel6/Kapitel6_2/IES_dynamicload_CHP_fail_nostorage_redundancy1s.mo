...
model IES_dynamicload_CHP_fail_nostorage_redundancy1s
  ...
  Modelica.Blocks.Logical.Switch switch2 "Regelung des produzierten Wärmestroms in der CHP nhand der Temperatur im Speicher."
...
end IES_dynamicload_CHP_fail_nostorage_redundancy1s;
