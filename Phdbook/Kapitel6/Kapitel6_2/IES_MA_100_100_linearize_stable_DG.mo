...
model IES_MA_100_100_linearize_stable_DG
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          ...
          textString="Stabiles IES-Modell zur Untersuchung des störungsfreien Langzeitverhaltens.")}),
                                                                         Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=10000,
      Interval=1,
      __Dymola_Algorithm="Dassl"));
end IES_MA_100_100_linearize_stable_DG;
