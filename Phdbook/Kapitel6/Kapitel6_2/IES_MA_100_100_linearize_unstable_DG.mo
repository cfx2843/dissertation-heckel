...
model IES_MA_100_100_linearize_unstable_DG
  ...
  TransiEnt.Producer.Electrical.Others.Biomass biomass_G1_Slack(
    ...
    P_el_n(displayUnit="MW") = 1500000000,
  ...
  TransiEnt.Producer.Combined.LargeScaleCHP.CHP CHP(
    ...
    Q_flow_n_CHP(displayUnit="MW") = 80000000,
    P_el_init=0,
    ...
    redeclare TransiEnt.Components.Electrical.Machines.ExcitationSystemsVoltageController.DCExciterWithOEL Exciter(oEL_summation(
        ...
        L3=380e3,
        K1=1,
        K3=0.01))) "Stromgesteuerte KWK zur Kogeneration von Wärme und Strom"                                                            annotation (Placement(transformation(extent={{52,-162},{102,-110}})));
  ...
  TransiEnt.Producer.Gas.Electrolyzer.PEMElectrolyzer_L1 electrolyzer(
    ...
    redeclare TransiEnt.Basics.Interfaces.Electrical.ComplexPowerPort epp) "Der Elektrolyseur wird bei Überfrequenzen aktiviert, sodass er zur Stabilisierung der Netzfrequenz beiträgt."
        ...
        rotation=-90,
        origin={-120,-2})));
  TransiEnt.Components.Gas.VolumesValvesFittings.Fittings.RealGasJunction_L2_isoth junction_FIS(volume=150) annotation (Placement(transformation(extent={{-130,-95},{-110,-115}})));
  ...
  TransiEnt.Producer.Heat.Power2Heat.ElectricBoiler.ElectricBoiler electricBoiler(
    Q_flow_n(displayUnit="MW") = 50000000,
    usePowerPort=true,
    redeclare TransiEnt.Basics.Interfaces.Electrical.ComplexPowerPort epp,
 ...
 TransiEnt.Basics.Blocks.LimPID PID_TWV(
  ...
  TransiEnt.Components.Heat.PumpVLE_L1_simple pumpProd1(presetVariableType="m_flow", m_flowInput=true)
        ...
        rotation=0,
        origin={228,-269})));
  Modelica.Blocks.Sources.RealExpression set_m_flow_pump2(y=CHP.m_flow_nom)          annotation (Placement(transformation(extent={{28,-206},{48,-186}})));
  ...
  TransiEnt.Components.Sensors.RealGas.GCVSensor gCVSensor_boundary annotation (Placement(transformation(extent={{-172,-104},{-152,-84}})));
  ...
  TransiEnt.Components.Sensors.RealGas.GCVSensor gCVSensor_chp annotation (Placement(transformation(
        ...
        rotation=0,
        origin={-48,-96})));
  Modelica.Blocks.Sources.RealExpression SetPower2(y=max(0, -250e6*(50 - CHP.epp.f)))
  ...
  Modelica.Blocks.Sources.Pulse    pulse(
    ...
    startTime=1000000000000)                                 annotation (Placement(transformation(extent={{-6,228},{-20,242}})));
  ...
  Modelica.Blocks.Sources.Ramp ramp1(
    ...
    duration=5000,
    offset=-30e6,
    startTime=0) annotation (Placement(transformation(extent={{-54,-70},{-34,-50}})));
  ...
  Modelica.Blocks.Sources.Step chpinput1(
    height=0,
    offset=0,
    startTime=100)    annotation (Placement(transformation(extent={{-20,-46},{0,-26}})));
  Modelica.Blocks.Sources.BooleanPulse BooleanFault3(
    width=25,
    period=100000,
    startTime(displayUnit="s") = 10000)
    annotation (Placement(transformation(extent={{84,-34},{100,-18}})));
protected
...
equation
  ...
  connect(CHP.epp, transmissionLine_Southern1.epp_p) annotation (Line(
      points={{100.75,-128.2},{164,-128.2},{164,-6}},
      color={28,108,200},
      thickness=0.5));
  ...
  connect(integrator.y, CHP.P_SB_set) annotation (Line(points={{-355.2,164},{-320,164},{-320,-18},{54.75,-18},{54.75,-121.05}},color={0,0,127}));
  connect(switch1.y, CHP.Q_flow_set) annotation (Line(points={{141,-38},{148,-38},{148,-116.067},{86.25,-116.067}},  color={0,0,127}));
  ...
  connect(CHP.outlet, hotWaterStorage.waterPortIn_prod[1]) annotation (Line(
      points={{102.5,-141.633},{116,-141.633},{116,-236},{26,-236},{26,-225.8}},
      color={175,0,0},
      thickness=0.5));
  connect(CHP.inlet, pumpProd.fluidPortOut) annotation (Line(
      points={{102.5,-147.7},{102.5,-235},{94,-235}},
      color={175,0,0},
      thickness=0.5));
  ...
  connect(set_m_flow_pump2.y, pumpProd.m_flow_in) annotation (Line(points={{49,-196},{76,-196},{76,-224}},  color={0,0,127}));
  ...
  connect(Lc.epp, Transformer_L_c.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(ramp1.y, switch2.u3) annotation (Line(points={{-33,-60},{-16,-60},{-16,-66},{20,-66},{20,-64}}, color={0,0,127}));
  connect(BooleanFault2.y,switch2. u2) annotation (Line(points={{2.8,-80},{10,-80},{10,-56},{20,-56}}, color={255,0,255}));
  connect(chpinput1.y,switch2. u1) annotation (Line(points={{1,-36},{14,-36},{14,-48},{20,-48}}, color={0,0,127}));
  connect(switch2.y, CHP.P_set) annotation (Line(points={{43,-56},{62,-56},{62,-116.067},{61.75,-116.067}}, color={0,0,127}));
  connect(BooleanFault3.y, switch1.u2) annotation (Line(points={{100.8,-26},{106,-26},{106,-38},{118,-38}}, color={255,0,255}));
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{-204,-118},{-374,-168}},
          lineColor={28,108,200},
          textString="Frequenzinstabiles IES-Modell")}),                 Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=50000,
      Interval=1,
      __Dymola_Algorithm="Dassl"));
end IES_MA_100_100_linearize_unstable_DG;
