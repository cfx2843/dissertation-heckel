...
model IES_dynamicload_normal_2s
  ...
  TransiEnt.Producer.Heat.Power2Heat.ElectricBoiler.ElectricBoiler electricBoiler(
    ...
    redeclare TransiEnt.Components.Boundaries.Heat.Heatflow_L1 heatFlowBoundary) "Elektrischer Boiler wird bei einem KWK-Ausfall an das Wärmenetz geschaltet, um die Versorgung zu übernehmen." annotation (Placement(transformation(extent={{238,-206},{218,-226}})));
  ...
  TransiEnt.Storage.Heat.HotWaterStorage_constProp_L4.HotWaterStorage_constProp_L4 hotWaterStorage(
    ...
    T_start(displayUnit="degC") = {358.15,358.15,358.15,358.15,343.25}) "Wärmespeicher mit der Kapazität den Nennwärmestrom der KWK über 2 Stunden zu versorgen."
        ...
        rotation=0,
        origin={13,-230})));
  TransiEnt.Components.Heat.Grid.IdealizedExpansionVessel idealizedExpansionVessel1(p(displayUnit="bar") = 600000) "Gefäß zur Anpassung des Volumens der Leitungen."
                                                                                                                   annotation (Placement(transformation(extent={{-12,-196},{2,-180}})));
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{-248,-132},{-252,-134}},
          lineColor={28,108,200},
          textString="Modell eines gekoppelten Energiesystems, was je nach Einstellung der Schalter folgende Störungen simuliert:

-Leitungsausfall
-KW-Ausfall
-Lastsprung
P_nbio")}),                                                              Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=86400,
      Interval=2,
