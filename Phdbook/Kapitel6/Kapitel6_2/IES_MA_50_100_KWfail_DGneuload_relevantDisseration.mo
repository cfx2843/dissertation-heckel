...
model IES_MA_50_100_KWfail_DGneuload_relevantDisseration
protected
...
public
  ...
  Modelica.Blocks.Sources.Pulse    pulse(
    ...
    startTime=7000)                                          annotation (Placement(transformation(extent={{-6,228},{-20,242}})));
  TransiEntDevZone.Sketchbook.jh.AdditionalComponentModels.DynamicExponentialElectricConsumerComplex_Frequency
                                                                          Lc(
    Tp=60,
    Tq=30,
...
equation
  ...
  connect(Lc.epp, Transformer_L_c.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(ramp1.y, CHP.P_set) annotation (Line(points={{-27,-32},{61.75,-32},{61.75,-90.0667}}, color={0,0,127}));
  connect(gain_CHP.y, CHP.Q_flow_set) annotation (Line(points={{68.4,42},{76,42},{76,-90.0667},{86.25,-90.0667}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{36,-46},{-414,-180}},
          lineColor={28,108,200},
          textString="IES-Modell bestehend aus einem Strom und Gassektor und zwei Wärmesektoren. Ein KW-Ausfall wird simuliert  ")}),
                                                                         Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=70000,
      Interval=1,
      __Dymola_Algorithm="Dassl"));
end IES_MA_50_100_KWfail_DGneuload_relevantDisseration;
