...
model IES_dynamicload_CHP_fail_storage_redundancy2s
  ...
  Modelica.Blocks.Sources.BooleanStep  BooleanFault2(startTime(displayUnit="s") = 31000)
  ...
  Modelica.Blocks.Logical.Switch switch2 "Schalter zur Aktivierung des Elektrischen Boilers nach der Störung"
                                         annotation (Placement(transformation(extent={{194,-180},{214,-160}})));
 ...
 TransiEnt.Basics.Blocks.LimPID PID_TWV(
  ...
  TransiEnt.Components.Heat.PumpVLE_L1_simple pumpProd1(presetVariableType="m_flow", m_flowInput=true)
        ...
        rotation=0,
        origin={228,-269})));
  Modelica.Blocks.Sources.BooleanStep  BooleanFault3(startTime(displayUnit="s") = 31000)
    annotation (Placement(transformation(extent={{346,-242},{330,-226}})));
  Modelica.Blocks.Logical.Switch switch3 "Schalter zur Aktivierung des Masseflusses zum Elektrischen Boiler."
  ...
  Modelica.Blocks.Math.Gain gain_CHP(k=-1) annotation (Placement(transformation(
   ...
   TransiEnt.Basics.Blocks.LimPID PID_CHP1(
    ...
    y_start=1,
    y_inactive=0) "Regelung des produzierten Wärmestroms in der CHP nhand der Temperatur im Speicher."
                  annotation (Placement(transformation(extent={{156,-136},{172,-120}})));
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{-204,-98},{-374,-148}},
          lineColor={28,108,200},
          textString="IES-Modell für einen KWK-Ausfall  bei t=30000 s und Redundanzzuschaltung bei t= 31000 s 
unter Verwendung eines Warmwasserspeichers.")}),                         Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=86400,
      Interval=2,
      __Dymola_Algorithm="Dassl"));
end IES_dynamicload_CHP_fail_storage_redundancy2s;
