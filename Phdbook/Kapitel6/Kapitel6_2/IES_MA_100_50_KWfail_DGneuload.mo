...
model IES_MA_100_50_KWfail_DGneuload
protected
...
equation
  ...
  connect(Lc.epp, Transformer_L_c.epp_n) annotation (Line(
      ...
      color={28,108,200},
      thickness=0.5));
  connect(gain_CHP.y, CHP.Q_flow_set) annotation (Line(points={{68.4,42},{78,42},{78,34},{86.25,34},{86.25,-90.0667}}, color={0,0,127}));
...
end IES_MA_100_50_KWfail_DGneuload;
