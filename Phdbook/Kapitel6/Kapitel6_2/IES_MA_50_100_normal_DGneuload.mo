...
model IES_MA_50_100_normal_DGneuload
protected
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{34,-50},{-416,-184}},
          lineColor={28,108,200},
          textString="IES-Modell bestehend aus einem Strom und Gassektor und zwei Wärmesektoren.")}),
                                                                         Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=70000,
      Interval=1,
      __Dymola_Algorithm="Dassl"));
end IES_MA_50_100_normal_DGneuload;
