...
model IES_dynamicload_CHP_fail_nostorage_noredundancy2s
...
equation
  ...
  connect(pulse.y, CHP.P_set) annotation (Line(points={{53,-20},{61.75,-20},{61.75,-90.0667}},
                                                                                             color={0,0,127}));
...
end IES_dynamicload_CHP_fail_nostorage_noredundancy2s;
