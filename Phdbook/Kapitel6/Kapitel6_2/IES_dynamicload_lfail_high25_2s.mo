...
model IES_dynamicload_lfail_high25_2s
  ...
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex La(
    ...
    beta_t=2.5,
    v_n(displayUnit="kV") = 220000,
    P_n(displayUnit="MW") = 1.25*101.5e6,
    Q_n=1.25*50.75e6)
                 annotation (Placement(transformation(
        extent={{10,-10},{-10,10}},
        rotation=90,
  ...
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex Lb(
    ...
    beta_t=10,
    v_n(displayUnit="kV") = 220000,
    P_n(displayUnit="MW") = 1.25*1522.5e6,
    Q_n=1.25*558.25e6)
                  annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
  ...
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex Lc(
    ...
    v_n(displayUnit="kV") = 220000,
    Q_n=1.25*50.75e6,
    P_n(displayUnit="MW") = 1.25*100.5e6)
                                       annotation (Placement(transformation(
        extent={{-11,-11},{11,11}},
        rotation=-90,
        origin={121,57})));
  TransiEnt.Consumer.Electrical.DynamicExponentialElectricConsumerComplex L2(
    ...
    beta_t=2.5,
    v_n(displayUnit="kV") = 220000,
    P_n(displayUnit="MW") = 1.25*126.875e6,
    Q_n=1.25*76.125e6)
                  annotation (Placement(transformation(
        extent={{-10,-10},{10,10}},
        rotation=-90,
...
equation
  ...
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{-188,-102},{-368,-138}},
          lineColor={28,108,200},
          textString="IES-Modell für einen Leitungsausfall bei t=10000 s unter 1.25 x Ausgangslast.")}),
                                                                         Icon(coordinateSystem(extent={{-400,-280},{360,260}})),
    experiment(
      StopTime=86400,
      Interval=2,
      __Dymola_Algorithm="Dassl"));
end IES_dynamicload_lfail_high25_2s;
