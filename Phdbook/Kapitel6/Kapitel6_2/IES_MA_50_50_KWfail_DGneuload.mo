...
model IES_MA_50_50_KWfail_DGneuload
protected
...
equation
  ...
  connect(gain_CHP.y, CHP.Q_flow_set) annotation (Line(points={{68.4,42},{86.25,42},{86.25,-90.0667}}, color={0,0,127}));
  annotation (Diagram(coordinateSystem(extent={{-400,-280},{360,260}}), graphics={
        Text(
          extent={{34,-58},{-416,-192}},
...
end IES_MA_50_50_KWfail_DGneuload;
