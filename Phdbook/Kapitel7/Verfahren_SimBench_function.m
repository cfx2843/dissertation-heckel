...
%ClusterDistanz wird nur für das Distanzverfahren benutzt und daher erst
...
for i=1:AnzK
    ...
    if Knoten(i,5)==1
        ...
        else %Zuordnung zum letzten Cluster jeins, über jzwei werden weitere Einträge erstellt, damit diese nicht überschrieben werden
